...
public class CreateEndpointTest extends AbstractIntegrationTest {
    ...
    private void assertThing(ThingExtra dtoThing, JsonNode json) {
    ...
    private void assertDatastream(DatastreamExtra expectedLocation, JsonNode datastream) {
    ...
    public void testCreateThingSimple() throws Exception {
        // Given
        ThingExtra dtoThing = new ThingExtra();
    ...
    public void testCreateThingWithLocationAndDatastream() throws Exception {
        ...
        ThingExtra dtoThing2 = new ThingExtra();
        ...
        DatastreamExtra datastream1 = DtoFactory.getDatastreamMinimal();
        DatastreamExtra datastream2 = DtoFactory.getDatastreamWithSensor();
        DatastreamExtra datastream3 = DtoFactory.getDatastreamWithSensorObservedProperty();
    ...
    public void testCreateThingExistsDatastream() throws Exception {
        ...
        DatastreamExtra datastream = DtoFactory.getDatastreamMinimal();
        HttpResponse<String> response = queryPost("/Datastreams", datastream);
        DatastreamExtra createdDatastream = mapper.readValue(response.body(), DatastreamExtra.class);
        DatastreamExtra IdDatastream = new DatastreamExtra();
