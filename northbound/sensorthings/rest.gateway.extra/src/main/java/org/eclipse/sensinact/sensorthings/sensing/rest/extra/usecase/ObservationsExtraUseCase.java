...
public class ObservationsExtraUseCase extends AbstractExtraUseCase<Observation, ResourceSnapshot> {
    ...
    public ExtraUseCaseResponse<ResourceSnapshot> delete(ExtraUseCaseRequest<Observation> request) {
        return new ExtraUseCaseResponse<ResourceSnapshot>(false, "fail to get providerSnapshot");

    }

    public ExtraUseCaseResponse<ResourceSnapshot> patch(ExtraUseCaseRequest<Observation> request) {
        return new ExtraUseCaseResponse<ResourceSnapshot>(false, "fail to get providerSnapshot");
    ...
    public ExtraUseCaseResponse<ResourceSnapshot> update(ExtraUseCaseRequest<Observation> request) {
        return new ExtraUseCaseResponse<ResourceSnapshot>(false, "fail to get providerSnapshot");
