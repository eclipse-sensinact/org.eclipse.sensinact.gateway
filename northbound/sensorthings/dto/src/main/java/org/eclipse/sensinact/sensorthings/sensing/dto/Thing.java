...
public record Thing(String selfLink, Object id, String name, String description,
        ...
        @JsonProperty("Locations@iot.navigationLink") String locationsLink) implements NameDescription {
}
