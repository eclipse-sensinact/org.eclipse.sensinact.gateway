    ...
    class ResourceParsing {
        ...
        void testRootResponse() throws IOException {
            ...
            List<String> expected = List.of(
                    ...
                    "HistoricalLocations", "https://toronto-bike-snapshot.sensorup.com/v1.0/HistoricalLocations",
                    "Datastreams", "https://toronto-bike-snapshot.sensorup.com/v1.0/Datastreams",
                    "Sensors", "https://toronto-bike-snapshot.sensorup.com/v1.0/Sensors",
        ...
        void testThings() throws IOException {
            ...
            assertThing(things.value().get(1), 1581, "https://toronto-bike-snapshot.sensorup.com/v1.0/Things(1581)",
                ...
                "7216:Wellington Dog Park", "https://toronto-bike-snapshot.sensorup.com/v1.0/Things(1581)/Datastreams",
            ...
            assertThing(things.value().get(2), 1573, "https://toronto-bike-snapshot.sensorup.com/v1.0/Things(1573)",
                ...
                "7211:Fort York/Garrison", "https://toronto-bike-snapshot.sensorup.com/v1.0/Things(1573)/Datastreams",
        ...
        void testLocations() throws IOException {
            ...
            assertLocation(locations.value().get(1), 1582, "https://toronto-bike-snapshot.sensorup.com/v1.0/Locations(1582)",
            ...
            assertLocation(locations.value().get(2), 1574, "https://toronto-bike-snapshot.sensorup.com/v1.0/Locations(1574)",
        ...
        void testHistoricalLocations() throws IOException {
            ...
            assertHistoricalLocation(locations.value().get(1), 1583, "https://toronto-bike-snapshot.sensorup.com/v1.0/HistoricalLocations(1583)",
                    "2017-02-02T20:45:24.966Z", "https://toronto-bike-snapshot.sensorup.com/v1.0/HistoricalLocations(1583)/Locations",
                    "https://toronto-bike-snapshot.sensorup.com/v1.0/HistoricalLocations(1583)/Thing");
            assertHistoricalLocation(locations.value().get(2), 1575, "https://toronto-bike-snapshot.sensorup.com/v1.0/HistoricalLocations(1575)",
    ...
    class ResourceSerialization {
        ...
        void testLocation() throws Exception {
            Location location = new Location("https://toronto-bike-snapshot.sensorup.com/v1.0/Locations(206048)",
                    ...
                    "The geographic location with coordinates for the Toronto bike share station Bloor St / Brunswick Ave",
                    "application/vnd.geo+json", new Point(new Coordinates(-79.407224, 43.665876), null, null),
                    "https://toronto-bike-snapshot.sensorup.com/v1.0/Locations(206048)/Things",
                    "https://toronto-bike-snapshot.sensorup.com/v1.0/Locations(206048)/HistoricalLocations");
        ...
        void testDatastream() throws Exception {
            Datastream datastream = new Datastream("https://toronto-bike-snapshot.sensorup.com/v1.0/Datastreams(1512)", 1512,
                    "7203:Harrison/Dovercourt:available_bikes",
                    "The datastream of available bikes count for the Toronto bike share station Harrison/Dovercourt",
                    "http://www.opengis.net/def/observationType/OGC-OM/2.0/OM_CountObservation",
                    new UnitOfMeasurement("bike count", "{TOT}", "http://unitsofmeasure.org/ucum.html#para-50"),
                    null, null, null, null,
                    "https://toronto-bike-snapshot.sensorup.com/v1.0/Datastreams(1512)/Observations",
        ...
        void testObservation() throws Exception {
            Observation observation = new Observation("https://toronto-bike-snapshot.sensorup.com/v1.0/Observations(1595550)", 1595550,
        ...
        void testObservedProperty() throws Exception {
            ObservedProperty observedProperty = new ObservedProperty("https://toronto-bike-snapshot.sensorup.com/v1.0/ObservedProperties(2)", 2,
                    "available_docks", "The total number count of available docks in a bike station",
        ...
        void testFeatureOfInterest() throws Exception {
            FeatureOfInterest featureOfInterest = new FeatureOfInterest("https://toronto-bike-snapshot.sensorup.com/v1.0/FeaturesOfInterest(1514)", 1514,
                    "7203:Harrison/Dovercourt", "Generated using location details: The geographic location with coordinates for the Toronto bike share station Harrison/Dovercourt",
                    "application/vnd.geo+json", new Point(new Coordinates(-79.424557, 43.650978), null, null),
