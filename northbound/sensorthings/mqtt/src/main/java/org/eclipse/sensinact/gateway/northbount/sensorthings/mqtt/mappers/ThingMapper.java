...
public class ThingMapper extends ThingsMapper {
    ...
    public ThingMapper(String topicFilter, String id, ObjectMapper mapper, GatewayThread thread) {
        super(topicFilter, mapper, thread);
        this.provider = id;
    }

    @Override
    public Promise<Stream<Thing>> toPayload(ResourceNotification notification) {
