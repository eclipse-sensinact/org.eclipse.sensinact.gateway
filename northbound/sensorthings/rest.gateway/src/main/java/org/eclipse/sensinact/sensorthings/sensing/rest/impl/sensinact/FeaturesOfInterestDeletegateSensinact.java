...
public class FeaturesOfInterestDeletegateSensinact extends AbstractDelegate {

    public FeaturesOfInterestDeletegateSensinact(UriInfo uriInfo, Providers providers, Application application,
