...
public class Activator extends AbstractActivator<Mediator> {
    ...
    public void doStart() throws Exception {
        ...
        if (manager == null) {
            manager = new ExtModelInstanceBuilder(super.mediator, Packet.class).withStartAtInitializationTime(true).buildConfiguration("fan-resource.xml", Collections.<String, String>emptyMap());
        }
        if (connector == null) {
