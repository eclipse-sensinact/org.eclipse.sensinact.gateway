...
/**
 * Declarative predicate on the stored value: the conjunction (AND) of simple
 * comparisons against typed literals. Execution is capability-gated
 * ({@link HistoryCapability#VALUE_FILTERING}); providers without the
 * capability reject queries carrying a filter with
 * {@link UnsupportedHistoryOperationException}.
 */
