...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.eclipse.fennec.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,org.eclipse.sensinact.sensorthings.models.sensorthings\"" })
...
public class SensorthingsConfigurationComponent {
	...
	public void activate(BundleContext ctx) {
		...
		if(!EPackage.Registry.INSTANCE.containsKey(SensorthingsPackage.eNS_URI)){
			EPackage.Registry.INSTANCE.put(SensorthingsPackage.eNS_URI, ePackage);
		}
