 ...
 */
package org.eclipse.sensinact.gateway.device.mosquitto.lite.it.util;
 ...
 */
public abstract class MosquittoTestITAbstract {
    ...
    protected Provider createDevicePojo(String providerString,String serviceString,String resourceString,String topic){
        ...
        mb.setHost(MQTT_HOST);
        mb.setPort(Long.parseLong(MQTT_PORT));
