...
public class MosquittoBridgeTest extends MosquittoTestITAbstract {
    ...
    @Test
    public void testResourceValueUpdateFetchRest() throws Exception {
    ...
    @Test(timeout = 10000)
    public void testResourceValueUpdateSubscription() throws Exception {
    ...
    class RecipientCustom implements Recipient {
        ...
        public void callback(String callbackId, SnaMessage[] messages) throws Exception {
            ...
            synchronized (MosquittoBridgeTest.this){
                MosquittoBridgeTest.this.notify();
            }
        }
