...
public class SensiNactFactoryImpl extends EFactoryImpl implements SensiNactFactory {
	 ...
	 * @generated
	 */
	public SensiNactFactoryImpl(SensiNactPackage ePackage) {
		super();
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SensiNactPackage.LOCATION: return createLocation();
	...
	public Location createLocation() {
		LocationImpl location = new LocationImpl(ePackage.getLocation());
		return location;
	}
