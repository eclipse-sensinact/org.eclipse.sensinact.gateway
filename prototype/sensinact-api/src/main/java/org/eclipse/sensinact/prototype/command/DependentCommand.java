...
/**
 * A {@link DependentCommand} provides a simple way to write a command which depends upon the result
 * of a previous parent command. This command will correctly delay execution of the dependent command
 * until the parent command has completed. It will do this without blocking the Gateway Thread. 
 * 
