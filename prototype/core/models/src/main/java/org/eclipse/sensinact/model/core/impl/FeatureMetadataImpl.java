 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sensinact.model.core.impl.FeatureMetadataImpl#getTypedKey
 * <em>Key</em>}</li>
 * <li>{@link org.eclipse.sensinact.model.core.impl.FeatureMetadataImpl#getTypedValue
 * <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureMetadataImpl extends MinimalEObjectImpl.Container
        implements BasicEMap.Entry<EStructuralFeature, Metadata> {
    /**
        ...
        if (key != null && key.eIsProxy()) {
            ...
            if (key != oldKey) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SensiNactPackage.FEATURE_METADATA__KEY,
                            oldKey, key));
            }
        }
        return key;
    ...
    public NotificationChain basicSetTypedValue(Metadata newValue, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    SensiNactPackage.FEATURE_METADATA__VALUE, oldValue, newValue);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newValue != value) {
            ...
            if (value != null)
                msgs = ((InternalEObject) value).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - SensiNactPackage.FEATURE_METADATA__VALUE, null, msgs);
            if (newValue != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET, SensiNactPackage.FEATURE_METADATA__VALUE, newValue,
                    newValue));
    }
