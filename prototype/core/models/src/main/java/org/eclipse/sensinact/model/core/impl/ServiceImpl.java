 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sensinact.model.core.impl.ServiceImpl#getMetadata
 * <em>Metadata</em>}</li>
 * </ul>
 *
 * @generated
...
public class ServiceImpl extends MinimalEObjectImpl.Container implements Service {
    ...
    public EMap<EStructuralFeature, Metadata> getMetadata() {
        if (metadata == null) {
            metadata = new EcoreEMap<EStructuralFeature, Metadata>(SensiNactPackage.eINSTANCE.getFeatureMetadata(),
                    FeatureMetadataImpl.class, this, SensiNactPackage.SERVICE__METADATA);
        }
        return metadata;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
        case SensiNactPackage.SERVICE__METADATA:
