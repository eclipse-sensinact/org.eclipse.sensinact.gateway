 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sensinact.model.core.impl.MetadataImpl#getFeature
 * <em>Feature</em>}</li>
 * <li>{@link org.eclipse.sensinact.model.core.impl.MetadataImpl#getTimestamp
 * <em>Timestamp</em>}</li>
 * <li>{@link org.eclipse.sensinact.model.core.impl.MetadataImpl#getSource
 * <em>Source</em>}</li>
 * </ul>
 *
 * @generated
...
public class MetadataImpl extends MinimalEObjectImpl.Container implements Metadata {
    ...
    protected EClass eStaticClass() {
        return SensiNactPackage.eINSTANCE.getMetadata();
    }
        ...
        if (feature != null && feature.eIsProxy()) {
            ...
            if (feature != oldFeature) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SensiNactPackage.METADATA__FEATURE,
                            oldFeature, feature));
            }
        }
        return feature;
    ...
    public void setFeature(EStructuralFeature newFeature) {
        ...
        feature = newFeature;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SensiNactPackage.METADATA__FEATURE, oldFeature,
                    feature));
    }
    ...
    public EObject getSource() {
        if (source != null && source.eIsProxy()) {
            ...
            if (source != oldSource) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, SensiNactPackage.METADATA__SOURCE,
                            oldSource, source));
            }
        }
        return source;
    ...
    public void setSource(EObject newSource) {
        ...
        source = newSource;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SensiNactPackage.METADATA__SOURCE, oldSource,
                    source));
    }
