 ...
 * @generated
 */
public class MetadataImpl extends MinimalEObjectImpl.Container.Dynamic.Permissive implements Metadata {
	/**
		...
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SensiNactPackage.METADATA__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(EStructuralFeature newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensiNactPackage.METADATA__FEATURE, oldFeature, feature));
	}
	...
	public EObject getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SensiNactPackage.METADATA__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(EObject newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SensiNactPackage.METADATA__SOURCE, oldSource, source));
	}
