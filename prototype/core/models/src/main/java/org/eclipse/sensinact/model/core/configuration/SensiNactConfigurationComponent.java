 ...
 * @generated
 */
@Component(name = "SensiNactConfigurator", reference = @Reference(name = "ResourceSetFactory", service = org.gecko.emf.osgi.ResourceSetFactory.class, cardinality = ReferenceCardinality.MANDATORY))
@Capability(namespace = "osgi.service", attribute = {
        "objectClass:List<String>=\"org.eclipse.sensinact.model.core.SensiNactFactory, org.eclipse.emf.ecore.EFactory\"",
        "uses:=org.eclipse.emf.ecore,org.eclipse.sensinact.model.core" })
@Capability(namespace = "osgi.service", attribute = {
        "objectClass:List<String>=\"org.eclipse.sensinact.model.core.SensiNactPackage, org.eclipse.emf.ecore.EPackage\"",
        "uses:=org.eclipse.emf.ecore,org.eclipse.sensinact.model.core" })
@Capability(namespace = "osgi.service", attribute = {
        "objectClass:List<String>=\"org.gecko.emf.osgi.EPackageConfigurator\"",
        "uses:=org.eclipse.emf.ecore,org.eclipse.sensinact.model.core" })
@Capability(namespace = "osgi.service", attribute = {
...
public class SensiNactConfigurationComponent {
     ...
     * @generated
     */
    private SensiNactEPackageConfigurator registerEPackageConfiguratorService(SensiNactPackage ePackage,
            BundleContext ctx) {
     ...
     * @generated
     */
    private void registerEPackageService(SensiNactPackage ePackage, EPackageConfigurator packageConfigurator,
            BundleContext ctx) {
        Hashtable<String, Object> properties = new Hashtable<String, Object>();
        properties.putAll(packageConfigurator.getServiceProperties());
     ...
     * @generated
     */
    private void registerEFactoryService(SensiNactPackage ePackage, EPackageConfigurator packageConfigurator,
            BundleContext ctx) {
        Hashtable<String, Object> properties = new Hashtable<String, Object>();
        properties.putAll(packageConfigurator.getServiceProperties());
