 ...
 * specification</a>
 */
public record MultiPoint(List<Coordinates> coordinates, List<Double> bbox, @JsonAnySetter @JsonAnyGetter Map<String,Object> foreignMembers) implements Geometry {
