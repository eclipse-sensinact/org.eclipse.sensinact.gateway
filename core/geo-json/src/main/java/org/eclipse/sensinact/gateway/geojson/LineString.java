 ...
 * specification</a>
 */
public record LineString(List<Coordinates> coordinates, List<Double> bbox, @JsonAnySetter @JsonAnyGetter Map<String,Object> foreignMembers) implements Geometry {
