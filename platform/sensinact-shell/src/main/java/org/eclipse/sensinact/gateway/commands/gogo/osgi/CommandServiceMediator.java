...
{
    public static String uri(String serviceProvider, 
    		String service, String resource, boolean multi)
    {
    ...
    public static String uri(String serviceProvider, 
    		String service, String resource, String method)
    {
    	StringBuilder builder = new StringBuilder();
    		...
    		InvalidCredentialException 
    {
        ...
        {
            this.endpoint = new NorthboundEndpoint(this, 
