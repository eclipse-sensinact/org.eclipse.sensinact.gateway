...
public class TestRestSUBSCRIBE_UNSUBSCRIBEAccess  extends TestRestAccess
{
	...
	public void testHttpAccessMethodSUBSCRIBE_UNSUBSCIBE() throws Exception
	{
        ...
        response = new JSONArray(message).getJSONObject(0);
	...
	{	
        ...
        simulated = this.synchronizedRequest(client, WS_ROOTURL + 
        	"/providers/slider/services/cursor/resources/position/SUBSCRIBE", null);
	...
	static class JettyTestServerCallback
	{
		...
		@doPost
		public void callbackPost(HttpServletRequest request,
				HttpServletResponse response) throws IOException
		{
			...
			if(length > -1)
			{
				byte[] content = IOUtils.read(
					request.getInputStream(),length, false);
