...
public class Util {
	...
	private static Logger LOG = LoggerFactory
			.getLogger(Util.class.getCanonicalName());

	public static final int createRequest(String cseBase, String method,
			String origin, String path, String contentType, JSONObject content)
			throws IOException {
		...
		if (path != null) {
			configuration.setUri(new StringBuilder().append(cseBase)
		...
		LOG.debug("HTTP response code {}, with payload '{}'", status,
				resp.toString());
		return status;
	}
