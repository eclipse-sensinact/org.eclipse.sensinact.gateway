...
public class TestLdapFiltering extends MidOSGiTest
{
	...
	public void testLdapFilter() throws Exception
	{
		...
		super.createDynamicBundle(
			...
			new File("./src/test/resources/resources.xml"),
	    ...
	    String simulated1  = HttpServiceTestClient.newRequest(mediator, HTTP_ROOTURL 
	    + "/ldap:sensinact?ldap='(service1.humidity.accessible=false)'",
	    null, "GET");
	    ...
	    HTTP_ROOTURL + "/sensinact/sensor0/service1/humidity/SET", 
	    "[{\"name\":\"attributeName\",\"type\":\"string\", \"value\":\"accessible\"},"
	    ...
	    simulated1  = HttpServiceTestClient.newRequest(mediator, HTTP_ROOTURL 
	    + "/ldap:sensinact?ldap='(service1.humidity.accessible=false)'",
	    null, "GET");

	    assertTrue(new JSONObject(simulated1).getJSONArray("providers").length()==1);
	    assertEquals("sensor0", new JSONObject(simulated1).getJSONArray("providers"
	    		).getJSONObject(0).getString("name"));
	    
	    System.out.println(simulated1);

	    String simulated3  = HttpServiceTestClient.newRequest(mediator, 
	    HTTP_ROOTURL + "/sensinact/sensor3/service1/humidity/SET", 
	    "[{\"name\":\"attributeName\",\"type\":\"string\", \"value\":\"accessible\"},"
	    + "{\"name\":\"value\",\"type\":\"boolean\", \"value\":false}]",
	    "POST");
	    ...
	    list.add(new JSONObject(simulated1).getJSONArray("providers"
	    		).getJSONObject(0).getString("name"));
	    list.add(new JSONObject(simulated1).getJSONArray("providers"
	    ...
	    String simulated4  = HttpServiceTestClient.newRequest(mediator, 
	    HTTP_ROOTURL + "/sensinact/sensor3/service1/temperature/SET", 
	    "[{\"name\":\"value\",\"type\":\"float\", \"value\":2.5}]",
	    "POST");
	    ...
	    simulated1  = HttpServiceTestClient.newRequest(mediator, HTTP_ROOTURL 
	    + "/ldap:sensinact?ldap='(service1.temperature.value%20<=%204.0)'",
	    null, "GET");
	    
	    System.out.println(simulated1);

	    assertTrue(new JSONObject(simulated1).getJSONArray("providers").length()==1);
	    assertEquals("sensor3", new JSONObject(simulated1).getJSONArray("providers"
	    		).getJSONObject(0).getString("name"));
	    
	    String simulated5  = HttpServiceTestClient.newRequest(mediator, 
	    HTTP_ROOTURL + "/sensinact/sensor2/service1/temperature/SET", 
	    "[{\"name\":\"value\",\"type\":\"float\", \"value\":2.5}]",
	    "POST");
	    ...
	    simulated1  = HttpServiceTestClient.newRequest(mediator, HTTP_ROOTURL 
	    + "/ldap:sensinact?ldap='(service1.temperature.value<=4.0)'",
	    null, "GET");
	    ...
	    simulated1  = HttpServiceTestClient.newRequest(mediator, HTTP_ROOTURL 
	    + "/ldap:sensinact?ldap='(%26(service1.humidity.accessible=false)(service1.temperature.value<=4))'",
	    null, "GET");
