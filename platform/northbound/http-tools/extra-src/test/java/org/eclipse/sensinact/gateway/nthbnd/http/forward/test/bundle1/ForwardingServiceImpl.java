		...
		return new Executable<Request, String>() 
		{
			...
			public String execute(Request request) throws Exception 
			{
				...
				try
				{
					...
					switch(val)
					{
					case 0:uri = uriContext.concat("/providers");
					break;
					case 1:uri = uriContext.concat("/providers/slider");
					break;
					case 2:uri = uriContext.concat("/providers/light");
					break;
					case 3:uri = uriContext.concat("/providers/slider/cursor/position/GET");
					break;
					}
