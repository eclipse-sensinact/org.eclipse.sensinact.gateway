...
public class CallbackFactory {
			...
			ExtHttpService extHttpService) 
	{
		...
		this.callbacks = Collections.synchronizedMap(
				new HashMap<String,CallbackServlet>());
	...
	public void start()
	{
		...
		attachAll();
		this.appearingKey = mediator.attachOnServiceAppearing(CallbackService.class,
				(String)null, new Executable<CallbackService,Void>()
		{
			@Override
		...
		this.disappearingKey = mediator.attachOnServiceDisappearing(CallbackService.class, 
				(String)null, new Executable<CallbackService,Void>()
		{
			@Override
			public Void execute(CallbackService callbackService) throws Exception 
	...
	public void stop() 
	{
		...
		mediator.detachOnServiceAppearing(CallbackService.class, (String)
				null,appearingKey);
		mediator.detachOnServiceDisappearing(CallbackService.class,(String)
	...
	public final void attach(CallbackService callbackService)
	{
		...
		CallbackServlet CallbackServlet = new CallbackServlet(mediator, 
				callbackService.getCallbackProcessor());
