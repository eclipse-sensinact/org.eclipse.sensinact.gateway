	...
	//********************************************************************//
		...
		public void testForwarding() throws Exception
		{
	        ...
	        String simulated2  =HttpServiceTestClient.newRequest(mediator, 
	        		HTTP_ROOTURL + "/forwardingTest1/0",null, "GET");
	        System.out.println(simulated2);
	        
	        JSONAssert.assertEquals(new JSONObject(simulated1).getJSONArray(
	        	"providers"), new JSONArray(simulated2),false);
	        
	        simulated1  = HttpServiceTestClient.newRequest(mediator,
	             	HTTP_ROOTURL + "/sensinact/providers/slider", null, "GET");
	        System.out.println(simulated1);
	        
	        simulated2 = HttpServiceTestClient.newRequest(mediator, 
	        		HTTP_ROOTURL + "/forwardingTest1/1",null, "GET");
	        System.out.println(simulated2);
	        
	        JSONAssert.assertEquals(new JSONObject(simulated1), 
	        		new JSONObject(simulated2),false);
		}
		...
		public void testCallback() throws Exception
		{
			...
			{
			String simulated1  = HttpServiceTestClient.newRequest(mediator,
	             	HTTP_ROOTURL + "/callbackTest1", null, "GET");
	        
	        System.out.println(simulated1);
	        assertEquals("[GET]/callbackTest1",simulated1);

	        String simulated2  = HttpServiceTestClient.newRequest(mediator,
	             	HTTP_ROOTURL + "/callbackTest1/withContent", "MyContent", "POST");
		...
		private void initializeMoke(File manifestFile,
