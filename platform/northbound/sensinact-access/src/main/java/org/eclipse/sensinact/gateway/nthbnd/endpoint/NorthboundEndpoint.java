...
public class NorthboundEndpoint
{
     ...
     */
    public AccessMethodResponse get(String serviceProviderId, 
     ...
     * @return the response containing the value of the resource
     */
    public AccessMethodResponse set(String serviceProviderId,
       String serviceId, String resourceId, String attributeId,
              Object value) 
    {  	
        Resource resource = this.resource(serviceProviderId, 
     ...
     * @return the response containing the value of the resource
     */
    public AccessMethodResponse act(String serviceProviderId,
     ...
     */
    public AccessMethodResponse subscribe(NorthboundRecipient recipient, 
     ...
     */
    public AccessMethodResponse unsubscribe(String serviceProviderId, 
    		String serviceId, String resourceId, String attributeId,
