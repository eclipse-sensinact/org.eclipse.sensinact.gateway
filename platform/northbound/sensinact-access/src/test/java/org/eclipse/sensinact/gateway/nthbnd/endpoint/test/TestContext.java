...
{          
	private static final String CORE_FILTER = "("+Constants.OBJECTCLASS+"="+
	...
	private static final String XFILTERING_FILTER = "(&("+Constants.OBJECTCLASS+"="+
		Filtering.class.getCanonicalName()+")(type=xfilter))";

	private static final String YFILTERING_FILTER = "(&("+Constants.OBJECTCLASS+"="+
		Filtering.class.getCanonicalName()+")(type=yfilter))";
	...
	private final ServiceRegistration registrationCore = 
	...
	private final ServiceReference referenceCore = 
			Mockito.mock(ServiceReference.class);

	private final ServiceReference xfilteringReference = 
			Mockito.mock(ServiceReference.class);
	
	private final ServiceReference yfilteringReference = 
			Mockito.mock(ServiceReference.class);
	                    ...
	                    throws Throwable
	            {
					...
					} else if((Filtering.class.equals(arguments[0]) && arguments[1]==null))
					{
						...
						} else
						{
							...
							"(type=xfilter)".equals(arguments[1])))
					{
		                ...
		                return Collections.emptyList();
							...
							"(type=yfilter)".equals(arguments[1])))
					{
					...
					} else if((Core.class.equals(arguments[0])
							&& arguments[1]==null)||(arguments[0]==null &&
							arguments[1].equals(CORE_FILTER)))
					{
