...
public class MyModelInstance extends ModelInstance<ModelConfiguration> {
     ...
     * resource
     */
    public <I extends ModelInstance<?>, M extends ModelElementProxy, P extends ProcessableData, E extends Nameable, R extends Nameable> AccessLevelOption getAccessLevelOption(ModelElement<I, M, P, E, R> modelElement, String publicKey) {
    ...
    public <I extends ModelInstance<?>, M extends ModelElementProxy, P extends ProcessableData, E extends Nameable, R extends Nameable> List<MethodAccessibility> getAuthorizations(ModelElement<I, M, P, E, R> modelElement, AccessLevelOption accessLevelOption) {
        ...
        List<MethodAccessibility> methodAccessibilities = this.configuration().getAccessibleMethods(path, accessLevelOption);
