...
public class TestJsonPathFiltering extends MidOSGiTest
{
	...
	protected static final String HTTP_ROOTURL = "http://localhost:8093";
	...
	protected void doInit(Map configuration)
	{
	    ...
	    "file:target/felix/bundle/json-path.jar "
		...
		configuration.put("org.osgi.service.http.port", "8093");
	...
	public void testHttpFiltered() throws Exception
	{
        ...
        String simulated2  = HttpServiceTestClient.newRequest(mediator, 
        	HTTP_ROOTURL + "/jsonpath:sensinact/providers?jsonpath=$.[:1]", null, "GET");
