 ...
 */
public class ConnectionConfigurationImpl<RESPONSE extends Response,
REQUEST extends Request<RESPONSE>> extends HeadersCollection 
...
{	
	 ...
	 * 
	 * @param configuration
	 * 		JSON formated string describing the 
			...
			String configuration)
	{
		...
		for(;index < length;index++)
		{
			...
			{
				queryParameter(object.optString("key"),
    ...
    {
    	return ConnectionConfiguration.HttpURLConnectionBuilder.build(
			this);
    }
