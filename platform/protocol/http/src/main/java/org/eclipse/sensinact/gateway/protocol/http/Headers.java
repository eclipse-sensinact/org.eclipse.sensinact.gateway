...
public interface Headers extends Iterable<String>
{
     ...
     * 
     * @param headers
     * 		the Map of all the headers to add
     */
     ...
     * 
     * @param header
     * 		the field for which to add the field value 
     * @param value
     ...
     * 
     * @param header
     * 		the field for which to add the list of field
     * 		values 
     * @param values
     * 		the list of field values to add
     */
     ...
     * 
     * @param header
     * 		the field name for which to return the list 
     * 		of values 
     * @return
     * 		the unmodifiable List of Strings that 
     ...
     * @return
     * 		the String concatenation of the list of
     ...
     * 
     * @return
     * 		 the unmodifiable Map of all header fields
     */
