...
public class MidClient<RESPONSE extends Response, REQUEST extends Request<RESPONSE> & Reusable> extends AbstractStackEngineHandler<REQUEST> {
     ...
     *
     * @return the maximum size of the Stack of {@link
     * Reusable}s of this IntermediateClient
     */
     ...
     *
     * @param intialDelay the initial delay between two tries of an {@link
     *                    Reusable} execution
     */
     ...
     * delay.
     *
     * @return the initial delay between two tries of an {@link
     * Reusable} execution
     */
     ...
     * Reusable} execution when an error occurred
     *
     * @return the maximum delay between two tries of an {@link
     * Reusable} execution
     */
     ...
     * Reusable} execution
     *
     * @return the delay before the next try of {@link
     * Reusable} execution
     */
