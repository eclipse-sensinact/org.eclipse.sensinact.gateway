...
public class TestHttpProtocolJetty
{
	...
	private class MidRequest extends SimpleRequest implements Reusable
	{
		...
		{
			return new MidRequest(
			(ConnectionConfiguration<SimpleResponse, SimpleRequest>) 
			super.configuration,this.reusable);
		}
	...
	{	
        String simulated;		
        simulated = TestHttpProtocolJetty.newRequest(HTTP_ROOTURL  + 
	...
	public void testHttpMidClient() throws Exception
	{
		...
		MidClient<SimpleResponse,MidRequest> client =
		new MidClient<SimpleResponse,MidRequest>(listener);
