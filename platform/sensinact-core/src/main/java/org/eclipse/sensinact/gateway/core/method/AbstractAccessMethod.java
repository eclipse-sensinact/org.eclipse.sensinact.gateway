...
public abstract class AbstractAccessMethod<T, R extends AccessMethodResponse<T>> implements AccessMethod<T, R> {
     ...
     */
    protected abstract <A extends AccessMethodResponseBuilder<T, R>> A createAccessMethodResponseBuilder(Object[] parameters);
     ...
     * Constructor
     *
     * @param type the {@link AccessMethod.Type} of the extended
     ...
     *
     * @param parameterTypes the array of types of the searched {@link Signature}
     * @return the {@link Signature} of this method whose parameter
     ...
     *
     * @param parameterTypes the array of types of the {@link Signature} to create
     ...
     *
     * @param parameterTypes the array of parameter types of the {@link
     *                       Signature} to create
     * @param names          the array of parameter string names of the
     ...
     * @param executor       the {@link AccessMethodExecutor} to map
     *                       to the {@link Signature} to create
     * @param policy         the {@link AccessMethodExecutor.Execu tionPolicy}
     ...
     * @param parameterTypes the parameter types array
     * @param executor       the {@link AccessMethodExecutor} to map to the
     *                       {@link Signature} to create
     * @param policy         the {@link AccessMethodExecutor.ExecutionPolicy}
     *                       of the specified {@link AccessMethodExecutor}
     * @throws InvalidConstraintDefinitionException
     */
    public void addSignature(Class<?>[] parameterTypes, String[] parameterNames, AccessMethodExecutor executor, AccessMethodExecutor.ExecutionPolicy policy) {
        Signature signature = this.getSignature(parameterTypes);
        if (signature != null) {
            this.addSignature(signature, executor, policy);
            return;
     ...
     *
     * @param signat   the {@link Signature} to add
     * @param executor the {@link AccessMethodExecutor} to map to the
     *                 {@link Signature}
     * @param policy   the {@link AccessMethodExecutor.ExecutionPolicy}
     *                 of the specified {@link AccessMethodExecutor}
    ...
    public void addSignature(Signature signature, AccessMethodExecutor executor, AccessMethodExecutor.ExecutionPolicy policy) {
        ...
        if (fixedParameters != null && !fixedParameters.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                try {
                    ((AccessMethodExecutorWrapper) methodExecutor).put(entry.getKey(), new Fixed(this.mediator.getClassLoader(), parameter.getType(), parameter.getValue(), false));
     ...
     * parameter
     *
     * @param shortcut  the {@link Shortcut} to register
     * @param signature the {@link Signature} already registered
     ...
     *
     * @param signature   the {@link Signature} of this method parameterizing
     *                    the invocation
