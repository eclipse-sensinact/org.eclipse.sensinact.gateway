...
public class SnaAgentImpl implements SnaAgent {
	...
	/**
	 * Creates an {@link SnaAgent} with the callback and filter which are passed as
	 * parameter
	 * 
	 * @param mediator
	 ...
	 * @param callback
	 *            the {@link AbstractMidAgentCallback} that will be called by
	 *            the{@link SnaAgent} to be created
	 * @param filter
	 ...
	 */
	public static SnaAgentImpl createAgent(Mediator mediator, MidAgentCallback callback, SnaFilter filter,
			String agentKey) {
	 ...
	 * transmitting them to the dedicated {@link AbstractMidAgentCallback}
	 */
	...
	/**
	 * Registers this SnaAgent into the referenced {@link RemoteCore}s
	 * 
	 * @param identifier
	...
	/**
	 * Registers this SnaAgent into the {@link RemoteCore} passed as parameter
	 * 
	 * @param remoteCore
	 *            the {@link RemoteCore} into which register this SnaAgent
	 * @param identifier
	 *            this SnaAgent's identifier
	 */
