 ...
 */
public abstract class AbstractSnaErrorfulMessage<S extends Enum<S> & KeysCollection & MessageSubType>
		extends AbstractSnaMessage<S> implements ErrorfulMessage<S> {
	/**
	 * Constructor
	 * 
	 * @param uri
	 ...
	 * @InheritedDoc
	 *
	 * @see ErrorfulMessage#setErrors(org.json.JSONArray)
	 */
	@Override
	 ...
	 * @inheritDoc
	 * 
	 * @see ErrorfulMessage# setErrors(java.lang.Exception)
	 */
	@Override
