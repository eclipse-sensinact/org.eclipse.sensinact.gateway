...
public class UnaccessibleAccessMethod implements AccessMethod<String, AccessMethodResponse<String>> {
    ...
    public AccessMethodResponse<String> invoke(Object[] parameters) {
        return AccessMethodResponse.<String, AccessMethodResponse<String>>error(this.mediator, uri, this.method, AccessMethodResponse.FORBIDDEN_ERROR_CODE, "Unaccessible method", null);
    }
