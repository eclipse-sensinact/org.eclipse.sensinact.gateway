...
/**
 * Extended {@link AccessMethodTrigger} whose execution result
 * depends on the validation of a {@link Constraint}
 * 
 * @author <a href="mailto:christophe.munilla@cea.fr">Christophe Munilla</a>
 */
public class ConditionalConstant 
implements AccessMethodTrigger<Object[]> 
{
	 ...
	 * on which to validate the constraint(s)
	 */
	 ...
	 * 		on which to validate the constraint(s)
	 * @param doPassOn
	 * 		defines whether the result object has to be pass on 
	 * 		for treatment
	 * @throws InvalidValueException 
	 */
	public ConditionalConstant(Mediator mediator, 
		int index, List<ConstraintConstantPair> constraints,
		boolean doPassOn) throws InvalidValueException
	{
	...
	public Object execute(Object[] parameters) throws Exception
	{
		...
		Iterator<ConstraintConstantPair> iterator = 
				this.constants.iterator();
