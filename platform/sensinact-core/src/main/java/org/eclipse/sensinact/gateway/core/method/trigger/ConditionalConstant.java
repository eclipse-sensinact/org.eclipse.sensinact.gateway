...
public class ConditionalConstant implements AccessMethodTrigger<Object[]> {
     ...
     *                 on which to validate the constraint(s)
     * @param doPassOn defines whether the result object has to be pass on
     *                 for treatment
     * @throws InvalidValueException
     */
    public ConditionalConstant(Mediator mediator, int index, List<ConstraintConstantPair> constraints, boolean doPassOn) throws InvalidValueException {
