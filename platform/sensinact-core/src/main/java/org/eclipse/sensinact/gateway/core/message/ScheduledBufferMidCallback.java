...
public class ScheduledBufferMidCallback extends BufferMidCallback {
     ...
     */
    public ScheduledBufferMidCallback(Mediator mediator, String identifier, ErrorHandler errorHandler, Recipient recipient, long timeout, int delay, int bufferSize) {
