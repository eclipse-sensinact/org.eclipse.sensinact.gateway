...
{	
	...
	/**
	 * Returns the AccessLevelOption providing the {@link AccessLevel} 
	 * at the same level than the one passed as parameter. If no 
	 * AccessLevelOption is found, the UNAUTHORIZED one id returned by 
	 * default
	 * 
	 * @param accessLevel
	 * 
	 * @return
	 */
	public static AccessLevelOption valueOf(
			AccessLevel accessLevel)
	{
		...
		{
			if(options[index].getAccessLevel().getLevel() 
