...
public interface DynamicParameterValue extends JSONable {
    ...
    public enum Type {
        ...
        CONDITIONAL, // copy one of the linked parameter
        COPY;
    }
    ...
    /**
     * Returns the name of the resource to which this
     * DynamicParameterValue is linked to
     *
     ...
     * {@link ResourceImpl}
     *
     * @param resourceValueExtractor the {@link Executable} value extractor to set
     */
