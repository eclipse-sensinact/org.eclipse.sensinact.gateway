...
public interface SensiNactResourceModelConfiguration {
    ...
    public enum BuildPolicy {
        ...
        BUILD_ON_DESCRIPTION((byte) 4), //when a service is discovered
        //all associated described resources are created
        BUILD_COMPLETE_ON_DESCRIPTION((byte) 5), //when a service is discovered
        //only resources providing data and previously
        //described are created
        BUILD_APPEARING_ON_DESCRIPTION((byte) 6), //build non described resources using a dedicated policy
     ...
     * started or not
     *
     * @param startAtInitializationTime <ul>
