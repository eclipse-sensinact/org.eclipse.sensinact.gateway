...
{   	
	/**
	 * Defines the policy applying on the build of resources 
	 * according to their previously defined description
	 * 
	 * @author <a href="mailto:christophe.munilla@cea.fr">Christophe Munilla</a>
	 */
	public enum BuildPolicy
	{
		 ...
		 * Constructor
		 * 
		 * @param policy the byte representation of 
		...
		/**
		 * Returns the byte representation of 
		 * this BuildPolicy
		 *  
		...
		/**
		 * Returns true if the byte representation of the BuildPolicy 
		 * passed as parameter includes the one specified; returns
		 * false otherwise
		 * 
		 * @param policy the byte representation of the BuildPolicy
		 * @param buildPolicy the BuildPolicy to check whether it is
		 * included in the byte representation or not
		 * 
		 * @return true if the byte representation of the BuildPolicy 
		 * includes the one specified; false otherwise
		 */
	 ...
	 * 
	 * @return
	 * 		the extended {@link ServiceProviderImpl} type in use
	 */
	 ...
	 * 
	 * @return
	 * 		the extended {@link ServiceImpl} type in use
	 */
	 ...
	 * 
	 * @return
	 * 		the extended {@link ResourceImpl} type in use
	 */
	Class<? extends ResourceImpl> getResourceImplementationType();

	/**
   	 * Returns the byte representing the {@link BuildPolicy}(s) 
   	 * that apply on non described resource instantiation
     * 
     * @return the byte representing the {@link BuildPolicy}(s)
     * applying on resources
   	 */
     byte getResourceBuildPolicy();

	/**
   	 * Returns the byte representing the {@link BuildPolicy}(s) 
   	 * that apply on non described service instantiation
     * 
     * @return the byte representing the {@link BuildPolicy}(s)
     * applying on services
   	 */
     byte getServiceBuildPolicy();
    
    /**
     * Returns true if the root element of the SensiNactResourceModel
     * configured by this SensiNactResourceModelConfiguration is started
     * when created or not
     * 
     * @return
     * 	<ul>
     * 		<li>true if the root element of the resource model 
     * 			is started automatically when created
     *      </li>
	 ...
	 */
	SensiNactResourceModelConfiguration setServiceImplmentationType(
	 ...
	 */
	SensiNactResourceModelConfiguration setResourceImplementationType(
			Class<? extends ResourceImpl> resourceType);
    
	/**
	 * Set the default extended {@link Resource} interface to be used 
	 * by the {@link ResourceConfigBuilder} attached to this 
	 * SensiNactModelConfiguration 
	 * 
	 * @param defaultResourceType the default {@link Resource}
	 * interface to be used
	 * 
	 * @return this SensiNactResourceModelConfiguration
	 */
	SensiNactResourceModelConfiguration setDefaultResourceType(
			Class<? extends Resource> defaultResourceType);

	/**
	 * Set the default data Type to be used by the {@link 
	 * ResourceConfigBuilder} attached to this SensiNactModelConfiguration 
	 * 
	 * @param defaultDataType the default data Type to be used
	 * 
	 * @return this SensiNactResourceModelConfiguration
	 */
	SensiNactResourceModelConfiguration setDefaultDataType(
			Class<?> defaultDataType);

	/**
	 * Set the default {@link Modifiable} to be used by the 
	 * {@link ResourceConfigBuilder} attached to this 
	 * SensiNactModelConfiguration 
	 * 
	 ...
	 * @return this SensiNactResourceModelConfiguration
	 */
	SensiNactResourceModelConfiguration setDefaultModifiable(
	 ...
	 * @return this SensiNactResourceModelConfiguration
	 */
	SensiNactResourceModelConfiguration setDefaultUpdatePolicy(
			Resource.UpdatePolicy defaultUpdatePolicy);
	
    /**
   	 * Defines the byte representing the {@link BuildPolicy}(s) 
   	 * to be applied on non described resources instantiation
     * 
     * @param buildPolicy the byte representing the {@link 
     * BuildPolicy}(s) applying on resources
   	 */
     SensiNactResourceModelConfiguration setResourceBuildPolicy(
       		byte buildPolicy);

    /**
     * Defines the byte representing the {@link BuildPolicy}(s) 
     * to be applied on non described services instantiation
     * 
     * @param buildPolicy the byte representing the {@link 
     * BuildPolicy}(s) applying on services
     */
     SensiNactResourceModelConfiguration setServiceBuildPolicy(
        	byte buildPolicy);

    /**
   	 * Defines whether an newly instantiated resource is automatically
   	 * started or not
     * 
     ...
     * 		</ul>
   	 */
     SensiNactResourceModelConfiguration setStartAtInitializationTime(
