 ...
 *
 * @param <T> the type of the described {@link AccessMethod}
...
public class Signature implements JSONable, Iterable<Parameter>, Cloneable {
     ...
     * Constructor
     *
     * @param methodType the type of the associated {@link SnaObjectMethod}
     * @param parameters this Signature {@link Parameter}s
     *                   array
     */
     ...
     * Constructor
     *
     * @param type           the type of the {@link AccessMethod} associates
    ...
    protected Signature(Mediator mediator, String name, AccessMethodResponse.Response returnedType, Parameter[] parameters) {
        this.mediator = mediator;
        this.name = name;
    ...
    /**
     * Returns the name of the described
     * {@link AccessMethod}
     *
     * @return the name of the described {@link
     * AccessMethod}
     */
    ...
    /**
     * Returns the extended {@link SnaMessageType}
     * of the associated {@link SnaObjectMethod} invocation
     * response object
     *
     * @return the associated {@link AccessMethod} invocation
     * response type
     */
    ...
    /**
     * Returns the parameter types array of the method this
     * Signature reifies the signature of
     *
    ...
    /**
     * Returns true if the name and parameter types of the
     * Signature passed as parameter are respectively equal
     * to the name and parameter types of this one; returns
     * false otherwise
     *
     * @param method the Signature to test the signature of
     * @return true if the name and parameter types of the
     * Signature are respectively equal to the name
     * and parameter types of this one ; returns
     * false otherwise
     */
    ...
    /**
     * Returns true if the name and parameter types passed as
     * parameters are respectively equal to the name and
     * parameter types of this Signature; returns false otherwise
     *
     * @param name           the name to compare with the one of this Signature
     * @param parameterTypes the parameter types array to compare with the one
     *                       of this Signature
     * @return true if the name and parameter types are respectively
     * equal to the name and parameter types of this Signature ;
    ...
    /**
     * Returns the {@link Parameter} whose name is
     * passed as parameter
     *
     * @param name the name of the parameter to return
     * @return the {@link Parameter} whose name is
     * specified
     */
    ...
    /**
     * Returns the {@link Parameter} whose index is
     * passed as parameter
     *
     * @param index the index of the parameter to return
     * @return the {@link Parameter} whose index is
     * specified
     */
     ...
     * Signature's set of {@link Parameter}s
     *
     * @return the array of this Signature's {@link
    ...
    /**
     * Returns true if the array of {@link Parameter}s passed as
     * parameter contains {@link Parameter}s of the same type and
     * in the same order than this current {@link Set} ; returns false
     * otherwise
     *
     * @param methodParameters the array of {@link Parameter}s to evaluate the order and
     *                         the types of
     * @return true if the array of {@link MethodParameter}s passed as
     * parameter contains parameters of the same type and
     * in the same order than this current {@link Set}; false
     * otherwise
     */
    ...
    /**
     * Returns true if the objects array passed as
     * parameter contains valid object to set as
     * values of held {@link Parameter}s; returns
     * false otherwise
     *
     * @param methodParameters the array of {@link Parameter}s to evaluate
     *                         the order and the types of
     * @return true if the array of {@link Parameter}s
     * passed as parameter contains parameters
     * of the same type and in the same order
     * than this current {@link Set}; false
     * otherwise
     */
    ...
    /**
     * Returns true if the objects array passed as
     * parameter contains valid object values to set   of the same type and
     * in the same order than this current {@link Set} ; returns false
     * otherwise
     *
     * @param methodParameters the array of {@link Parameter}s to evaluate the order and
    ...
    /**
     * Returns the length of the held array of
     * parameters
     *
     * @return the length of the held array of
     * parameters
     */
    public int length() {
