...
/**
 * A Parameter of an {@link AccessMethod} on which can apply 
 * set of constraints
 * 
 * @author <a href="mailto:christophe.munilla@cea.fr">Christophe Munilla</a>
 */
public class Parameter extends Primitive 
implements JSONable, Cloneable
{
	 ...
	 */
	public Parameter(Mediator mediator, String name, Class<?> type) 
			throws InvalidValueException
	{
	 ...
	 * @throws InvalidValueException 
	 */
	public Parameter(Mediator mediator, 
			String name, Class<?> type, Object value) 
			throws InvalidValueException
	{
	 ...
	 * @throws InvalidValueException 
     */
    public Parameter (Mediator mediator, JSONObject parameter) 
            throws InvalidValueException
    {
		...
		{
			this.fixedValue = null;
			JSONArray constraints = parameter.optJSONArray(
			...
			try 
			{
				for(;index < length; index++)
				{
					JSONObject constraintJSON = 
							constraints.getJSONObject(index);					
					Constraint constraint = ConstraintFactory.Loader.load(
						super.mediator.getClassLoader(),constraintJSON);
    ...
    /**
	 * Returns true if the value of the {@link Parameter} 
	 * argument can be set to this one ; also 
	 * checks whether its name is the same as the 
	 * current one if the 'strict' argument is defined 
	 ...
	 * @return
	 * 		<ul>
	 * 		  <li>true if the parameter argument value 
	 *            can be set to this one</li>
	 * 		  <li>false otherwise</li>
	 * 		</ul>
	 */
	public boolean validParameter(
	        Parameter parameter, boolean strict)
	{
		boolean complies = (this.validParameter(
		        parameter.getValue()) && (!strict 
		        || super.getName().equals(
		        parameter.getName())));
		return complies;
	}
	
	/**
     * Returns true if the value of the parameter argument 
     * can be set to this Parameter ;
     * 
     * @param parameter
     *            the {@link Parameter} to evaluate
     * @return
    ...
    /**
     * Returns true if the JSON object parameter's value
     * can be set as value of this Parameter ;
     * 
     * @param parameter
     *            the {@link Parameter} to evaluate
     * @return
    ...
    /**
     * Returns true if the object argument 
     * can be set as value of this Parameter;
     * 
     * @param parameter
     ...
     * @return
     *      <ul>
     *          <li>true if the object argument
     *              can be set as value of this one</li>
     *          <li>false otherwise</li>
     *      </ul>
     */
	...
	/**
	 * Returns the JSONObject from which is based 
	 * the JSON formated string description of this
	 * Parameter
	 *  
	 * @return
	 * 		the basis JSONObject describing this
	 * 		Parameter
	 */
	...
	{
		if (Object.class != type && Object[].class != type &&
				!Recipient.class.isAssignableFrom(type) &&
	 ...
	 */
    @Override
    protected void afterChange(Object value) 
    		throws InvalidValueException
    {
 	   //do nothing
    }
