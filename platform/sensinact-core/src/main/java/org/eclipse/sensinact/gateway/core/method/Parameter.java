...
public class Parameter extends Primitive implements JSONable, Cloneable {
     ...
     * @throws InvalidValueException
     */
    public Parameter(Mediator mediator, String name, Class<?> type, Set<Constraint> constraints) throws InvalidValueException {
        super(mediator, name, type);
        this.fixed = false;
        this.fixedValue = null;
     ...
     * can be set as value of this Parameter;
     *
     * @param parameter the object to evaluate
     * @return <ul>
