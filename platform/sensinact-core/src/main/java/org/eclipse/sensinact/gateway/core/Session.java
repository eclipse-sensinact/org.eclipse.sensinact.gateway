...
public interface Session {
     ...
     * invocation, wrapped into a {@link GetResponse}
     */
     ...
     * into a {@link GetResponse}
     */
    GetResponse get(String requestId, String serviceProviderId, String serviceId, String resourceId, String attributeId);
     ...
     * invocation, wrapped into a {@link SetResponse}
     */
    SetResponse set(String serviceProviderId, String serviceId, String resourceId, String attributeId, Object parameter);
     ...
     * @return the JSON formated response of the SET access method
     * invocation, tagged by the specified request identifier and , wrapped
     * into a {@link SetResponse}
     */
    SetResponse set(String requestId, String serviceProviderId, String serviceId, String resourceId, String attributeId, Object parameter);
     ...
     * invocation, wrapped into a {@link ActResponse}
     */
     ...
     */
    ActResponse act(String requestId, String serviceProviderId, String serviceId, String resourceId, Object[] parameters);
     ...
     * invocation, wrapped into a {@link SubscribeResponse}
     */
    SubscribeResponse subscribe(String serviceProviderId, String serviceId, String resourceId, Recipient recipient, JSONArray conditions);
     ...
     */
    SubscribeResponse subscribe(String requestId, String serviceProviderId, String serviceId, String resourceId, Recipient recipient, JSONArray conditions);
     ...
     */
    UnsubscribeResponse unsubscribe(String serviceProviderId, String serviceId, String resourceId, String subscriptionId);
     ...
     */
    UnsubscribeResponse unsubscribe(String requestId, String serviceProviderId, String serviceId, String resourceId, String subscriptionId);
     ...
     * @return the JSON formated result of the {@link SnaAgent}
     * unregistration, wrapped into a {@link UnsubscribeResponse}
     */
     ...
     * and wrapped into a {@link UnsubscribeResponse}.
     */
     ...
     * instances for this Session, and wrapped into a {@link
     * DescribeResponse}
     */
     ...
     * sensiNact instance, as well as from the connected remote ones
     *
     * @param filterCollection the collection of the filters to be
     *                         applied on the result of the call
     * @return the JSON formated and filtered list of the resource model
     * instances for this Session, and wrapped into a {@link DescribeResponse}
     */
     ...
     * providers, wrapped into a {@link DescribeResponse}
     */
     ...
     * @return the JSON formated list of available services
     * for the specified service providers, wrapped into a
     ...
     */
    DescribeResponse<String> getServices(String requestId, String serviceProviderId, FilteringCollection filterCollection);
     ...
     * @param serviceId         the String identifier of the service providing
     *                          the resources
     * @return the JSON formated list of available resources
     ...
     * {@link DescribeResponse}
     */
    DescribeResponse<String> getResources(String serviceProviderId, String serviceId, FilteringCollection filterCollection);
     ...
     * specified request identifier, and wrapped into a {@link
     * DescribeResponse}
     */
    DescribeResponse<String> getResources(String requestId, String serviceProviderId, String serviceId, FilteringCollection filterCollection);
     ...
     * wrapped into a {@link DescribeResponse}
     */
    DescribeResponse<JSONObject> getResource(String requestId, String serviceProviderId, String serviceId, String resourceId);
}
