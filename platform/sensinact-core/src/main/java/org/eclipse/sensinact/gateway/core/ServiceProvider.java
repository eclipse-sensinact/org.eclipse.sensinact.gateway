 ...
 */
public interface ServiceProvider extends ElementsProxy<Service>, 
ServiceCollection, Localizable, Stateful<ServiceProvider.LifecycleStatus>
{
	public static final String LATITUDE_PROPERTY = 
			"org.eclipse.sensinact.gateway.location.latitude";
	
	public static final String LONGITUDE_PROPERTY = 
			"org.eclipse.sensinact.gateway.location.longitude";

	public static final double DEFAULT_CEA_LOCATION_LATITUDE =
			45.19334890078532d;
	public static final double DEFAULT_CEA_LOCATION_LONGITUDE = 
			5.706474781036377d;
