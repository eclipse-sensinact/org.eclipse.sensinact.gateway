...
public class TypeConfig implements Typable<TypeConfig.Type> {
	...
	public static enum Type {
		STATE_VARIABLE(Resource.Type.STATE_VARIABLE), SENSOR(Resource.Type.SENSOR), PROPERTY(
				Resource.Type.PROPERTY), LOCATION(Resource.Type.PROPERTY), ACTION(Resource.Type.ACTION);
	 ...
	 *            the interface implemented by the {@link ResourceImpl} configured
	 *            by the TypeConfig to instantiate
	 */
	 ...
	 * 
	 * @param type
	 *            the {@link TypeConfig.Type} of the TypeConfig to instantiate
	 */
	...
	/**
	 * Returns {@link Resource.Type} of the resources based on this
	 * {@link TypeConfig}
	 * 
	 * @return {@link Resource.Type} type of the resources based on this
	 *         {@link TypeConfig}
	 */
	...
	/**
	 * Returns the extended {@link ResourceImpl} base type used to create new
	 * instance using reflection
	 * 
	 * @return the extended {@link ResourceImpl} base type
	 */
	...
	/**
	 * Defines the extended {@link ResourceImpl} base type used to create new
	 * instance using reflection
	 * 
	 * @param baseClass
	...
	/**
	 * Returns the extended {@link ResourceImpl} type implemented by the resources
	 * based on this {@link ResourceInfo}
	 * 
	 * @return the extended {@link ResourceImpl} type implemented by the resources
	 *         based on this {@link ResourceInfo}
	 */
	...
	/**
	 * Returns the extended {@link Resource} interface implemented by the resources
	 * based on this {@link TypeConfig}
	 * 
	 * @return the extended {@link Resource} interface implemented by the resources
	 *         based on this {@link TypeConfig}
	 */
	...
	/**
	 * Sets the extended {@link ResourceImpl} type implemented by the resources
	 * based on this {@link ResourceInfo}
	 * 
	...
	/**
	 * Returns the default extended {@link ResourceImpl} implementation class
	 * 
	...
	/**
	 * Returns the value of the constant field whose name is passed as parameter in
	 * the list of the implemented interfaces
	 * 
	 * @param constant
	 *            the constant field name
	 * @param fromTop
	 *            search for the constant value from the top of the list or from the
	 *            bottom of the list of the implemented interface
	 * @return the constant field value
	 */
	public <T> T getConstantValue(String constant, boolean fromTop) {
		return ReflectUtils.<Resource, T>getConstantValue(this.list, constant, fromTop);
	}
