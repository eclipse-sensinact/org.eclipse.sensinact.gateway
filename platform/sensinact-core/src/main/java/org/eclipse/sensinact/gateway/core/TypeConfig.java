...
public class TypeConfig implements Typable<TypeConfig.Type> {
    ...
    public static enum Type {
        STATE_VARIABLE(Resource.Type.STATE_VARIABLE), SENSOR(Resource.Type.SENSOR), PROPERTY(Resource.Type.PROPERTY), LOCATION(Resource.Type.PROPERTY), ACTION(Resource.Type.ACTION);
     ...
     * Constructor
     *
     * @param implementationInterface the interface implemented by the {@link ResourceImpl}
     ...
     * Constructor
     *
     * @param type the {@link TypeConfig.Type} of the
     ...
     *
     * @return {@link Resource.Type} type of the resources
     * based on this {@link TypeConfig}
     */
     ...
     * to create new instance using reflection
     *
     * @param baseClass the extended {@link ResourceImpl} base type
     */
     ...
     *
     * @return the extended {@link ResourceImpl} type implemented by the
     * resources based on this {@link ResourceInfo}
     */
     ...
     *
     * @return the extended {@link Resource} interface implemented by the
     * resources based on this {@link TypeConfig}
     */
     ...
     * resources based on this {@link ResourceInfo}
     *
     * @param implementationClass the extended {@link ResourceImpl} type implemented by the
     *                            resources based on this {@link ResourceInfo}
     */
     ...
     * interfaces
     *
     * @param constant the constant field name
     * @param fromTop  search for the constant value from the top
