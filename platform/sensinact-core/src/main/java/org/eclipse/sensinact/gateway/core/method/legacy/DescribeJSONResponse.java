...
public class DescribeJSONResponse extends DescribeResponse<JSONObject> {
     ...
     */
    protected DescribeJSONResponse(Mediator mediator, String uri, Status status, DescribeMethod.DescribeType describeType) {
     ...
     */
    public DescribeJSONResponse(Mediator mediator, String uri, Status status, int code, DescribeMethod.DescribeType describeType) {
