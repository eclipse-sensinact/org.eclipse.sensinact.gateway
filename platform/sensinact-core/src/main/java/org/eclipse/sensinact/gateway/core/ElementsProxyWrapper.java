 ...
 */
public abstract class ElementsProxyWrapper<M extends ModelElementProxy, P extends Nameable> implements ElementsProxy<P>, InvocationHandler, Nameable, PathElement {
    /**
     * the proxied class
     */
     ...
     * Constructor
     *
     * @param proxy the extended {@link ModelElementProxy} to be wrapped
     *              by the ProxyWrapper to be instantiated
     */
    ...
    /**
     * Returns the {@link ModelElementProxy} wrapped
     * by this ProxyWrapper
     *
