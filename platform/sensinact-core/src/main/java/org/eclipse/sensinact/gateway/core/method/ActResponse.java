...
public class ActResponse extends AccessMethodResponse
{
    ...
    {
	    super(mediator, uri, 
	    	AccessMethodResponse.Response.ACT_RESPONSE, 
	    	status, code);
    }
	
	/**
	 * Returns the JSONArray of JSON formated {@link Description} of
	 * the {@link StateVariableResource} modified during the 
	 * execution of the ActMethod returning this {@link AccessMethodResponse}
	 *  
	 * @return
	 * 		the JSONArray of JSON formated {@link Description} of
	 * 		the modified {@link StateVariableResource}
	 */
	@SuppressWarnings("unchecked")
	public JSONArray getTriggers()
	{
        List<String> triggered = (List<String>) super.properties.get(
 				SnaConstants.TRIGGERED_KEY);
	...
	/**
	 * Add the JSON formated {@link Description} of a modified {@link 
	 * StateVariableResource} to this {@link AccessMethodResponse}
	 *  
	 * @param trigger
