...
public class DescribeJSONResponseBuilder extends 
DescribeResponseBuilder<JSONObject>
{	
    /**
     * Constructor
     * 
	 ...
	 * </ul>
     */
    protected DescribeJSONResponseBuilder(Mediator mediator, 
	 ...
	 */
    @Override
	public DescribeJSONResponse createAccessMethodResponse(
    		AccessMethodResponse.Status status)
    {
		return new DescribeJSONResponse(super.mediator, 
			super.getPath(), status, describeType);
    }
