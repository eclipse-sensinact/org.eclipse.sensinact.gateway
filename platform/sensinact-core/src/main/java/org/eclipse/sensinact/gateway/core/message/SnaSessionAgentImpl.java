...
public class SnaSessionAgentImpl extends SnaAgentImpl {
	...
	/**
	 * Creates an {@link SnaAgent} whose existence will be linked to the one of the
	 * {@link Session} passed as parameter with the callback and filter which are
	 * passed as parameter
	 * 
	 * @param mediator
	 *            the {@link Mediator} allowing the {@link SnaAgent} to be created
	 *            to interact with the OSGi host environment
	 * @param session
	 *            the {@link Session} to the existence of whom the {@link SnaAgent}
	 *            to be created will be linked
	 * @param callback
	 *            the {@link AbstractMidAgentCallback} that will be called by the
	 *            {@link SnaAgent} to be created
	 * @param filter
	 *            the {@link SnaFilter} that will be used by the {@link SnaAgent} to
	 *            be created to discriminate the handled {@link SnaMessage}s
	 * 
	 * @return the newly created {@link SnaAgent}
	 */
	public static SnaSessionAgentImpl createAgent(Mediator mediator, Session session, MidAgentCallback callback,
	 ...
	 * @param publicKey
	 */
	protected SnaSessionAgentImpl(Mediator mediator, Session session, MidAgentCallback callback, SnaFilter filter,
			String publicKey) {
