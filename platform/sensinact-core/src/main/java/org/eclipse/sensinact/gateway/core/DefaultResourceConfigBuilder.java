...
public class DefaultResourceConfigBuilder implements ResourceConfigBuilder {
    ...
    public ResourceConfig getResourceConfig(ResourceDescriptor resourceConfigDescriptor) {
        Class<? extends Resource> resourceType = (resourceConfigDescriptor.resourceType() == null) ? this.getDefaultResourceType() : resourceConfigDescriptor.resourceType();

        Class<? extends ResourceConfig> resourceConfigType = resourceConfigDescriptor.resourceConfigType();
        Class<? extends ResourceImpl> resourceImplementationType = resourceConfigDescriptor.resourceImplementationType();
