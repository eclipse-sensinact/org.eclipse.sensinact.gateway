...
public interface Core {
	...
	/**
	 * Instantiates and registers a new agent, connected to the {@link AgentMessageCallback} 
	 * and whose received messages are filtered by the {@link MessageFilter} passed as
	 * parameters 
	 * 
	 * @param mediator the {@link Mediator} allowing the agent to be instantiated 
	 * to interact with the OSGi host environment
	 * @param callback the {@link AgentMessageCallback} in charge of handling the
	 * messages transmitted to the agent to be instantiated
	 * @param filter the {@link MessageFilter} helping in filtering the messages
	 ...
	 */
	String registerAgent(Mediator mediator, AgentMessageCallback callback, MessageFilter filter);
