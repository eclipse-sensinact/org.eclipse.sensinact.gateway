 ...
 * blocked, according to its type, its source, or/and a set of {@link Constraint}s
 * 
 * @author <a href="mailto:cmunilla@cmssi.fr">Christophe Munilla</a>
 */
public class MessageFilter implements JSONable {
	/**
	 ...
	 * @param sender
	 */
	public MessageFilter(Mediator mediator, String sender) {
	 ...
	 * @param isComplement
	 */
	public MessageFilter(Mediator mediator, String sender, boolean isPattern, boolean isComplement) {
	 ...
	 * @param constraints
	 */
	public MessageFilter(Mediator mediator, String sender, JSONArray constraints) {
	 ...
	 * @param constraints
	 */
	public MessageFilter(Mediator mediator, String sender, boolean isPattern, boolean isComplement, JSONArray constraints) {
	...
	boolean matchesType(SnaMessage message) {
		return handledTypes.contains(((MessageSubType) message.getType()).getSnaMessageType());
	}
	...
	boolean matchesConditions(SnaMessage message) {
		...
		case REMOTE:
			...
			break;
		case UPDATE:
			switch ((UpdateMessage.Update) message.getType()) {
				case ACTUATED:
					return false;
	...
	public boolean equals(Object object) {
		if (!MessageFilter.class.isAssignableFrom(object.getClass())) {
			return false;
		}
		MessageFilter snaFilter = (MessageFilter) object;
