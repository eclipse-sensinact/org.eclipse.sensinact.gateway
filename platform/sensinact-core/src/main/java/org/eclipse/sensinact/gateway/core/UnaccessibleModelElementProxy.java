...
public class UnaccessibleModelElementProxy extends ModelElementProxy {
     ...
     * Constructor
     *
     * @param resource the proxied resource
     */
    ...
    public AccessMethodResponse<?> invoke(String type, Object[] parameters) throws Throwable {
        return AccessMethodResponse.error(super.mediator, super.path, AccessMethod.Type.valueOf(type.toUpperCase()), SnaErrorfulMessage.FORBIDDEN_ERROR_CODE, "Unaccessible object", null);
    }
