...
public abstract class AccessMethodResponseBuilder<T, A extends AccessMethodResponse<T>> extends Stack<T> implements PathElement {
     ...
     * parameter
     *
     * @param status      the {@link SnaMessage.Status} of the extended
     *                    {@link AccessMethodResponse} to be created
     * @param accessLevel the integer access level of the extended
     *                    {@link AccessMethodResponse} to be created
     ...
     *
     * @param index this index of the object parameter
     * @return this AccessMethodResult's object parameter
     * whose index is passed as parameter
     */
     ...
     *
     * @return the length of this parameter objects
     * array
     */
    public int length() {
    ...
    public A createAccessMethodResponse() {
        AccessMethodResponse.Status status = (exceptions != null && exceptions.size() > 0) ? AccessMethodResponse.Status.ERROR : AccessMethodResponse.Status.SUCCESS;
     ...
     *
     * @return the array of parameters parameterizing
     * the calls using this AccessMethodResult
     */
