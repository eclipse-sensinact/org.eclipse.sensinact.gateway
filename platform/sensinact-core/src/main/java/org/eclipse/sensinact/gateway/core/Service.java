...
public interface Service extends ElementsProxy<Resource>, ResourceCollection
{
	 ...
	 * 		the invocation {@link SnaMessage} result
	 */
	SetResponse set(String resourceName,
			String atributeName, Object value);	
	 ...
	 */
	SubscribeResponse subscribe(String resourceName,
			String attributeName, Recipient recipient);
	 ...
	 */
	SubscribeResponse subscribe(String resourceName, Recipient recipient, 
			Set<Constraint> conditions, long lifetime);
	 ...
	 * @return the {@link SnaMessage} resulting of the invocation
	 */
	UnsubscribeResponse unsubscribe(String resourceName, 
			String attributeName, String subscriptionId);
