...
public interface ServiceCollection {
    /**
     * Returns the set of all {@link Service}s
     * of this collection
     *
    ...
    /**
     * Returns the {@link Service} held by this
     * collection and whose name is passed as
     * parameter
     *
     * @param service the name of the {@link Service}
     * @return the {@link Service} of this collection
