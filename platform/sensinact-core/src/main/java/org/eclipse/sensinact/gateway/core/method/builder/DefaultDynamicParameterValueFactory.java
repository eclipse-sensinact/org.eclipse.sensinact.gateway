...
{	
	...
	public DynamicParameterValue newInstance(Mediator mediator, 
			Executable<Void,Object> resourceValueExtractor, JSONObject jsonBuilder) 
		...
		{			
			...
			switch(type)
			{
				case CONDITIONAL:
					...
					JSONArray constants = jsonBuilder.optJSONArray(
							DynamicParameterValue.BUILDER_CONSTANTS_KEY);
					...
					builder =  new ConditionalConstant(mediator, parameterName, 
				...
				default:
					throw new InvalidValueException(new StringBuilder().append(
							"Unknown builder identifier :").append(
									jsonType).toString());
			}			
		} catch(Exception e)
		{
