            ...
            switch (type) {
                case CONDITIONAL:
                    ...
                    for (; constantsIndex < length; constantsIndex++) {
                        ...
                        constraints.add(new ConstraintConstantPair(ConstraintFactory.Loader.load(mediator.getClassLoader(), constantObject.opt(DynamicParameterValue.BUILDER_CONSTRAINT_KEY)), constantObject.opt(DynamicParameterValue.BUILDER_CONSTANT_KEY)));
                    }
                ...
                case COPY:
                    ...
                    break;
                default:
                    throw new InvalidValueException(new StringBuilder().append("Unknown builder identifier :").append(jsonType).toString());
            }
        } catch (Exception e) {
