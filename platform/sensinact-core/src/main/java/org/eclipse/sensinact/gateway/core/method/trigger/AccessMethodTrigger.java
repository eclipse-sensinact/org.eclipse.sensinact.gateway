...
public interface AccessMethodTrigger<P> extends Executable<P, Object>, JSONable {
    ...
    public enum Type {
        ...
        CONSTANT, // copy one of the linked parameter
        COPY;
    }
    ...
    public enum Parameters {
        ...
        //expected
        EMPTY, //Initial Parameters array
        //Executor<Object[],Object> expected
        PARAMETERS, //Intermediate AccessMethodResult Parameter
        //Executor<AccessMethodResult,Object> expected
        INTERMEDIATE, //Resulting AccessMethodResponse Parameter
     ...
     * enum instance
     *
     * @return this AccessMethodTrigger's {@link Parameters}
     * enum instance
     */
