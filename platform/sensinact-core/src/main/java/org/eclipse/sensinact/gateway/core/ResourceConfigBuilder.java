...
public interface ResourceConfigBuilder {
     ...
     *
     * @param resourceConfigDescriptor the {@link ResourceDescriptor}
     *                                 describing the {@link ResourceConfig} to be returned
     * @return the {@link ResourceConfig} described by the
     * specified {@link ResourceDescriptor}
     */
    ...
    /**
     * Set the default data Type  to be used by this
    ...
    /**
     * Set the default {@link Modifiable}  to be used
     * by this ResourceConfigBuilder
     *
    ...
    /**
     * Set the default {@link Resource.UpdatePolicy}  to be used
     * by this ResourceConfigBuilder
     *
