...
public interface Core {
     ...
     */
    void createRemoteCore(AbstractRemoteEndpoint remoteEndpoint, Collection<Executable<String, Void>> onConnectedCallbacks, Collection<Executable<String, Void>> onDisconnectedCallbacks);
