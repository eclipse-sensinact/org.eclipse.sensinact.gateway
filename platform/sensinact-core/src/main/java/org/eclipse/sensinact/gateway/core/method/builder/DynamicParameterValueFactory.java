...
public interface DynamicParameterValueFactory {
    ...
    public final class Loader {
        ...
        public final DynamicParameterValueFactory load(Mediator mediator, String name) {
            ...
            ServiceLoader<DynamicParameterValueFactory> loader = ServiceLoader.load(DynamicParameterValueFactory.class, mediator.getClassLoader());
     ...
     *
     * @param type the string type of the {@link DynamicParameterValue}
     * @return <ul>
     ...
     *
     * @param mediator
     * @param resourceValueExtractor {@link ServiceImpl} allowing to retrieve the value
     *                               of the resource to which the DynamicParameterValue to
     *                               create is linked to
     * @param parameterName
     * @param builder                {@link JSONObject} describing the Calculation to
     *                               instantiate
     * @return a new {@link DynamicParameterValue} instance
     * @throws InvalidValueException if the {@link DynamicParameterValue} cannot be instantiated
     */
    DynamicParameterValue newInstance(Mediator mediator, Executable<Void, Object> resourceValueExtractor, JSONObject builder) throws InvalidValueException;
}
