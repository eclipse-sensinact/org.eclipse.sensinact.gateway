...
public interface DynamicParameterValueFactory
{
	 ...
	 */
	public static final ThreadLocal<Loader> LOADER = 
			new ThreadLocal<Loader>()
	{
		/**
		 * @inheritDoc
		 * 
	...
	public final class Loader
	{
		 ...
		 * 
		 * @param name
		 * 		the string operator for which to retrieve the
		 * 		appropriate CalculationFactory 
		 * @return
		 * 		a CalculationFactory instance handling the 
		 * 		string operator passed as parameter
		 */
		public final DynamicParameterValueFactory load(
				Mediator mediator, 
				String name)
		{
			...
			DefaultDynamicParameterValueFactory defaultFactory = 
					new DefaultDynamicParameterValueFactory();
			...
			ServiceLoader<DynamicParameterValueFactory> loader = 
				ServiceLoader.load(DynamicParameterValueFactory.class, 
	 ...
	 * create a {@link DynamicParameterValue} instance whose 
	 ...
	 * 				create a {@link DynamicParameterValue} instance
	...
	/**
	 * Creates and returns a {@link DynamicParameterValue} instance
	 * using its JSON formated description
	 * 
	 * @param mediator
	 * @param resourceValueExtractor
	 * 		{@link ServiceImpl} allowing to retrieve the value
	 * 		of the resource to which the DynamicParameterValue to
	 * 		create is linked to
	 * @param parameterName
	 * @param builder
	 * 		{@link JSONObject} describing the Calculation to
	 * 		instantiate 
	 * @return
	 * 		a new {@link DynamicParameterValue} instance 
	 * @throws InvalidValueException
	 * 		if the {@link DynamicParameterValue} cannot be instantiated
	 */
	 DynamicParameterValue newInstance(Mediator mediator,
