 ...
 */
public interface LifecycleMessage extends NotificationMessage<LifecycleMessage.Lifecycle> {
	...
	enum Lifecycle implements MessageSubType, KeysCollection {
		...
		Lifecycle() {
			List<TypedKey<?>> list = Arrays.asList(new SnaMessage.KeysBuilder(LifecycleMessage.class).keys());
