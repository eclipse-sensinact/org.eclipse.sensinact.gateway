...
public class ServiceProxy extends ModelElementProxy {
    ...
    final void buildMethods(ErrorHandler handler, List<MethodAccessibility> methodAccessibilities) throws InvalidValueException {
        ...
        Signature getSignature = new Signature(mediator, GET, new Class<?>[]{String.class, String.class}, new String[]{"resourceName", "attributeName"});

        Signature setSignature = new Signature(mediator, SET, new Class<?>[]{String.class, String.class, Object.class}, new String[]{"resourceName", "attributeName", "value"});

        Signature actSignature = new Signature(mediator, ACT, new Class<?>[]{String.class, Object[].class}, new String[]{"resourceName", "arguments"});

        Signature subscribeSignature = new Signature(mediator, SUBSCRIBE, new Class<?>[]{String.class, String.class, Recipient.class, Set.class}, new String[]{"resourceName", "attributeName", "listener", "conditions"});

        Signature unsubscribeSignature = new Signature(mediator, UNSUBSCRIBE, new Class<?>[]{String.class, String.class, String.class}, new String[]{"resourceName", "attributeName", "subscriptionId"});

        // Get method
        if (getMethod != null) {
            getMethod.addSignature(getSignature);
            Signature getAttributeShortcut = new Signature(mediator, GET, new Class<?>[]{String.class}, new String[]{"resourceName"});

            getMethod.addSignature(getAttributeShortcut);
            registerMethod(AccessMethod.GET, getMethod);

        } else {
            AccessMethod snaMethod = new UnaccessibleAccessMethod(mediator, getPath(), AccessMethod.Type.valueOf(AccessMethod.GET));
            registerMethod(AccessMethod.GET, snaMethod);
        }
        // Set method
        if (setMethod != null) {
            setMethod.addSignature(setSignature);
            Signature setAttributeShortcut = new Signature(mediator, SET, new Class<?>[]{String.class, Object.class}, new String[]{"resourceName", "value"});
            setMethod.addSignature(setAttributeShortcut);
            registerMethod(AccessMethod.SET, setMethod);

        } else {
            AccessMethod snaMethod = new UnaccessibleAccessMethod(mediator, getPath(), AccessMethod.Type.valueOf(AccessMethod.SET));
        ...
        if (actMethod != null) {
            ...
            AccessMethod snaMethod = new UnaccessibleAccessMethod(mediator, getPath(), AccessMethod.Type.valueOf(AccessMethod.ACT));
        ...
        if (subscribeMethod != null) {
            ...
            Signature subscribeConditionsShortcut = new Signature(mediator, SUBSCRIBE, new Class<?>[]{String.class, String.class, Recipient.class}, new String[]{"resourceName", "attributeName", "listener"});

            subscribeMethod.addSignature(subscribeConditionsShortcut);

            Signature subscribeNameConditionsShortcut = new Signature(mediator, SUBSCRIBE, new Class<?>[]{String.class, Recipient.class}, new String[]{"resourceName", "listener"});
            Signature subscribeNameShortcut = new Signature(mediator, SUBSCRIBE, new Class<?>[]{String.class, Recipient.class, Set.class}, new String[]{"resourceName", "listener", "conditions"});
            ...
            AccessMethod snaMethod = new UnaccessibleAccessMethod(mediator, getPath(), AccessMethod.Type.valueOf(AccessMethod.SUBSCRIBE));
        ...
        if (unsubscribeMethod != null) {
            ...
            Signature unsubscribeNameShortcut = new Signature(mediator, UNSUBSCRIBE, new Class<?>[]{String.class, String.class}, new String[]{"resourceName", "subscriptionId"});
            unsubscribeMethod.addSignature(unsubscribeNameShortcut);
            registerMethod(AccessMethod.UNSUBSCRIBE, unsubscribeMethod);

        } else {
            AccessMethod snaMethod = new UnaccessibleAccessMethod(mediator, getPath(), AccessMethod.Type.valueOf(AccessMethod.UNSUBSCRIBE));
