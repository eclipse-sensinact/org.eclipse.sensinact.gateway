...
public class AttributeDescription extends PrimitiveDescription
{
	 ...
	 * 		the array of {@link Description}s of the 
	...
	public String getJSON()
	{
		...
		description.put(VALUE_KEY, toJson(this.getType(),
					this.getValue()));
		...
		for(;index < length; index++)
		{
			MetadataDescription metadataDescription =
					this.metadataDescriptions[index];
				...
				!Modifiable.FIXED.equals(metadataDescription.getModifiable()))
			{
				description.put(metadataDescription.getName(), 
						toJson(metadataDescription.getType(),
	...
	protected JSONObject getJSONObjectDescription()
	{
		...
		{			
			description.put(VALUE_KEY, 
				toJson(this.getType(), this.getValue()));
		}
		// appends JSON description of Metadata
		// associated to the described Attribute
		...
		{			
			...
			JSONObject metadataDescriptionJSON = 
					metadataDescription.getJSONObjectDescription();
