...
public class AttributeDescription extends PrimitiveDescription {
     ...
     * Constructor
     *
     * @param attribute            the {@link Attribute} to describe
     * @param metadataDescriptions the array of {@link Description}s of the
     *                             {@link Metadata} which belong to the {@link Attribute}
     *                             to describe
     */
    ...
    /**
     * Returns true if the described {@link Attribute} JSON description is
    ...
    public String getJSON() {
        ...
        for (; index < length; index++) {
            ...
            if (!Metadata.LOCKED.equals(metadataDescription.getName()) && !Metadata.HIDDEN.equals(metadataDescription.getName()) && !Attribute.NICKNAME.equals(metadataDescription.getName()) && !Modifiable.FIXED.equals(metadataDescription.getModifiable())) {
                description.put(metadataDescription.getName(), toJson(metadataDescription.getType(), metadataDescription.getValue()));
            }
    ...
    protected JSONObject getJSONObjectDescription() {
        ...
        for (; index < length; index++) {
            ...
            if (Metadata.LOCKED.equals(metadataDescription.getName()) || Metadata.HIDDEN.equals(metadataDescription.getName())) {
                continue;
            }
