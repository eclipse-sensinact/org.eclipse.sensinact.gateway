...
{    			
			...
			ResourceConfigBuilder defaultResourceConfigBuilder)
	{
		this(mediator, accessTree, defaultResourceConfigBuilder, 
		    ServiceProviderImpl.class,  ServiceImpl.class, ResourceImpl.class);
	}
	...
	{
		this(mediator, accessTree, new DefaultResourceConfigBuilder(),
			defaultServiceProviderType, defaultServiceType,  defaultResourceType);
	}
	 ...
	 *  type to define as the default service provider one
	 * @param defaultServiceType the extended {@link ServiceImpl} type to define 
	 * as the default service one
	 * @param defaultResourceType the extended {@link ResourceImpl} type to define 
	 * as the default resource one 
	 */
	protected ModelConfiguration(
			Mediator mediator, 
			MutableAccessTree<? extends MutableAccessNode> accessTree,
			...
			Class<? extends ResourceImpl> defaultResourceType)
	{
		...
		ServiceLoader<ResourceConfigCatalog> loader = ServiceLoader.load(
			ResourceConfigCatalog.class, mediator.getClassLoader());
   ...
   /**
    * Returns the set of service names attached to 
    * the profile whose identifier is passed as 
    * parameter
    * 
    * @param profile the string profile name for which
    * to return the set of attached service names
    * 
    * @return the set of service names for the specified
    * profile
    */
    public List<String> getServices(String profile)
    {
    	...
    	{
        	String[] profiles = profile==null?
        		new String[]{ ResourceConfig.ALL_PROFILES }:
        	...
        	{
        		List<String> tobeAdded = this.profiles.get(
        				profiles[index]);
        		if(tobeAdded == null)
        		{
        			continue;
    ...
    /**
     * Returns the set of service names attached to 
     * the service provider whose identifier is passed as 
     * parameter
     * 
     * @param name the string service provider name for which
     * to return the set of attached service names
     * 
     * @return the set of service names for the specified
     * service provider
	 ...
	 */
	public ModelConfiguration setDefaultResourceType(
	 ...
	 */
	@Override
	public ModelConfiguration setProviderImplementationType(
	 ...
	 */
	@Override
	public ModelConfiguration setServiceImplmentationType(
	 ...
	 */
	@Override
	public ModelConfiguration setResourceImplementationType(
	...
	/**
  	 * Adds a {@link ResourceConfigCatalog} to the list of those of 
  	 * this ModelConfiguration
  	 * 
  	 * @param resourceConfigCatalog the {@link ResourceConfigCatalog} 
  	 * to add
  	 */
     public ModelConfiguration addResourceConfigCatalog(
    		 ResourceConfigCatalog resourceConfigCatalog)
     {
     ...
     public ResourceDescriptor getResourceDescriptor()
     {
     	...
     	descriptor.withResourceConfigType(
     			this.getResourceConfigType());
     	descriptor.withResourceImplementationType(
     			this.getResourceImplementationType());
     	return descriptor;
     }
 	 ...
 	 * if it exists in this ModelConfiguration's {ResourceConfigCatalog}s
 	 *  
 	...
 	{
 		return this.resourceConfigCatalogs.getResourceConfig(
 				descriptor);
 	}

 	/**
 	 * Creates and returns the {@link ResourceConfig} described by the {@link 
 	 * ResourceDescriptor} passed as parameter
 	 *  
 	 * @param descriptor the {@link ResourceDescriptor} describing the 
 	 * {@link ResourceConfig} to be returned
 	 * 
 	 * @return the {@link ResourceConfig} described by the specified {@link 
 	 * ResourceDescriptor}
 	 */
	 ...
	 * for the service whose name is passed as parameter
	 * 
			...
			String serviceId)
	{
		...
		this.resourceConfigCatalogs.iterator();
	    
	    while(iterator.hasNext())
	    {
	    	configs.addAll(iterator.next(
	    			).getResourceConfigs(profile, serviceId));
	    }
		return configs;
	}
	/**
	 * Returns the ResourceConfig of the default Resource
	 * of the service whose name is passed as parameter if it
	 * has been defined
	 * 
	 * @param serviceName the name of the service for which
	 * to retrieve the default {@link ResourceConfig} 
	 * 
	 ...
	 */
			 ...
			 String serviceName)
	 {
		ResourceConfig config = null;
 	    ...
 	    while(iterator.hasNext())
 	    {
 	    	config = iterator.next().getDefaultResourceConfig(
 	    			profile, serviceName);
 	    	if(config != null)
 	    	{
 	    		break;
	...
	/**
	 * Defines the {@link ResourceConfig} type provided by this 
	 * ModelConfiguration
	 * 
	 * @param resourceConfigType this ModelConfiguration's {@link 
	 * ResourceConfig} type
	 */
	public void setResourceConfigType(Class<? extends ResourceConfig> 
	resourceConfigType)
	{
	...
	/**
	 * Returns the {@link ResourceConfig} type provided by this 
	 * ModelConfiguration
	 * 
     ...
     * 		</ul>
   	 */
	@Override
     public ModelConfiguration setStartAtInitializationTime(
	 ...
	 *
	 * @see SensiNactResourceModelConfiguration#
	 * getAccessibleMethods(java.lang.String, 
	 * AccessLevelOption)
	 */
	@Override
