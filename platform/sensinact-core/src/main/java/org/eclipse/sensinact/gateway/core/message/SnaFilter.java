...
public class SnaFilter implements JSONable {
     ...
     *
     * @param jsonCondition the JSON formated {@link Constraint} to
     *                      add to this filter
     */
     ...
     *
     * @param jsonCondition the {@link Constraint} to add
     */
     ...
     *
     * @param message the {@link SnaMessage} to check whether it
     ...
     *
     * @param SnaMessage the {@link SnaMessage} to check whether its
