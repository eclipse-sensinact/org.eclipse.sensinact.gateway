 ...
 * allows also to retrieve the descriptions of available service providers,
...
public interface Endpoint {
	/**
	 * Returns the JSON formated list of all registered, and accessible by the user
	 * whose String public key is passed as parameter, resource model instances from
	 * the local sensiNact instance, as well as from the connected remote ones
	 * 
	 * @param publicKey
	 *            the String public key of the user for which to retrieve the list
	 *            of accessible resource model instances
	 * 
	...
	/**
	 * Returns the JSON formated list of all registered, accessible to the user
	 * whose String public key is passed as parameter, and compliant to the
	 * specified String LDAP formated filter, resource model instances from the
	 * local sensiNact instance, as well as from the connected remote ones
	 * 
	 * @param publicKey
	 *            the String public key of the user for which to retrieve the list
	 *            of accessible resource model instances
	 ...
	 * 
	 * @return the JSON formated list of the resource model instances for the
	 *         specified user and compliant to the specified filter.
	 */
	 ...
	 * 
	 * @param publicKey
	 *            the String public key of the user requiring the list of available
	 *            service providers
	 * 
	 ...
	 * 
	 * @param publicKey
	 *            the String public key of the user requiring the description
	 ...
	 * passed as parameter, held by the specified service provider and service, and
	 * for the user whose String public key is also passed as parameter
	 * 
	 * @param serviceProviderId
	 *            the String identifier of the service provider holding the service
	 ...
	 * 
	 * @param publicKey
	 *            the String public key of the user invoking the access method
	 * @param serviceProviderId
	 *            the String identifier of the service provider holding the service
	 *            providing the resource on which applies the access method call
	 * @param serviceId
