...
{		
	 ...
	 */
	List<MethodAccessibility> getAccessibleMethods(
	 ...
	 * on a {@link ModelElement} mapped to this AccessNode 
	 *  
	 * @param method the targeted {@link AccessMethod.Type}
	 * 
	 * @return  the minimum required {@link AccessLevelOption} to 
	 * be allowed to invoke the specified the {@link AccessMethod.Type}
	 */
     AccessLevelOption getAccessLevelOption(Type method);
     
    /**
     * Returns the child AccessNode of this one whose path
     * is passed as parameter, if it exists
     * 
     * @param path the path of the child AccessNode
     * 
