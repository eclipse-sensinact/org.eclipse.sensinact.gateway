...
public enum SubscriptionMode {
	...
	/**
	 * Returns true if the SubscriptionMode passed as parameter is present in the
	 * byte value representation of specified mode(s)
	 * 
	 * @param mode
	 *            byte value representation of subscription mode(s)
	...
	/**
	 * Builds and returns the byte value representation of the
	 * {@link SubscriptionMode}s array passed as parameter
	 * 
	 * @param modes
	 *            the array of {@link SubscriptionMode}s to build the byte value
	 *            representation of
	...
	/**
	 * Converts the byte value passed as parameter into the array of
	 * {@link SubscriptionMode}s whose byte values composed the specified one
	 * 
	 * @param mode
	 *            the byte value representation to convert
	 * @return the {@link SubscriptionMode}s array based on the specified byte value
	 *         representation
	 */
	public static SubscriptionMode[] valueOf(byte mode) {
		...
		for (; index < length; index++) {
			if (SubscriptionMode.contains(mode, modes[index])) {
	...
	/**
	 * Returns the JSON formated String description of the array of
	 * {@link SubscriptionMode}s passed as parameter using its processed byte value
	 * representation
	 */
