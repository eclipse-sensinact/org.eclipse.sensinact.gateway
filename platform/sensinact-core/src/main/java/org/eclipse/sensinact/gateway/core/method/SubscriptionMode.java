...
public enum SubscriptionMode {
    NONE((byte) 0x00), ON_CHANGE((byte) 0x01), SCHEDULED((byte) 0x02), CONDITIONAL((byte) 0x04), BUFFERIZED((byte) 0x08), TIMED_OUT((byte) 0x10);
     ...
     * Constructor
     *
     * @param mode byte identifier of the mode
     */
     ...
     *
     * @param mode             byte value representation of subscription
     *                         mode(s)
     * @param subscriptionMode the subscription mode to check the presence
     * @return
     */
     ...
     * parameter
     *
     * @param modes the array of {@link SubscriptionMode}s to build
     ...
     *
     * @param mode the byte value representation to convert
     * @return the {@link SubscriptionMode}s array based on
