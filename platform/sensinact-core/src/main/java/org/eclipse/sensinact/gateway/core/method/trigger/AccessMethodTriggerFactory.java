...
public interface AccessMethodTriggerFactory
{
	...
	public final class Loader
	{
		 ...
		 */
		public final AccessMethodTriggerFactory load(
				Mediator mediator, 
				String name)
		{
			...
			DefaultAccessMethodTriggerFactory defaultFactory = 
					new DefaultAccessMethodTriggerFactory();
			...
			ServiceLoader<AccessMethodTriggerFactory> loader = 
					ServiceLoader.load(AccessMethodTriggerFactory.class, 
	 ...
	 * 		instantiate 
	 * @return
	 * 		a new {@link AccessMethodTrigger} instance 
	 * @throws InvalidValueException
	 * 		if the {@link AccessMethodTrigger} cannot be instantiated
	 */
	 <P> AccessMethodTrigger<P> newInstance(Mediator mediator,
