...
public class Metadata extends DescribablePrimitive
{
	 ...
	 */
	public Metadata(Mediator mediator, 
	...
	/**
	 * Constructs a Metadata using the given
	 *  {@link JSONObject}
	 * 
	 * @param metadata
	 *       the {@link JSONObject} describing the 
	 *       Metadata to instantiate
	 * 
	 * @throws InvalidConstraintDefinitionException
	 */
	public Metadata(Mediator mediator, JSONObject metadata) 
			throws InvalidValueException
	{
		super(mediator, metadata);
		try
		{
			this.modifiable = Modifiable.valueOf(
				metadata.optString(
				Metadata.MODIFIABLE));
	...
	{
		if ((!type.isArray() 
		        || !Constraint.class.isAssignableFrom(
