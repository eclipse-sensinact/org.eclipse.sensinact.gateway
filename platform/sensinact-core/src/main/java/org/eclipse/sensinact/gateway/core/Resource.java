...
public interface Resource extends ElementsProxy<AttributeDescription>, Typable<Resource.Type>
{
	...
	static final AttributeBuilder[] ATTRIBUTES = new AttributeBuilder[]
	{
        ...
        new AttributeBuilder(NAME, new AttributeBuilder.Requirement[]
        { AttributeBuilder.Requirement.MODIFIABLE, AttributeBuilder.Requirement.HIDDEN, AttributeBuilder.Requirement.VALUE,  AttributeBuilder.Requirement.TYPE }).type(
        		String.class).hidden(true).modifiable(Modifiable.FIXED),
        // the type attribute is hidden and cannot be modified
        // value should be defined
        new AttributeBuilder(TYPE, new AttributeBuilder.Requirement[]
        { AttributeBuilder.Requirement.MODIFIABLE, AttributeBuilder.Requirement.HIDDEN, AttributeBuilder.Requirement.VALUE,  AttributeBuilder.Requirement.TYPE  }).type(
        		Resource.Type.class).hidden(true).modifiable(Modifiable.FIXED)
	};
	 ...
	 * 
	 * @param parameters
	 *            objects array parameterizing 
	 *            the invocation
	 * @return 
	 * 		the invocation {@link SnaMessage} result
	 */
