...
public class MokeDynamicParameterValueFactory implements DynamicParameterValueFactory {
     ...
     */
    @Override
    public DynamicParameterValue newInstance(Mediator mediator, Executable<Void, Object> resourceValueExtractor, JSONObject builder) throws InvalidValueException {
