...
public class TestContext<R extends ModelInstance> {
	...
	private final ServiceRegistration referenceCore = Mockito.mock(ServiceRegistration.class);
	...
	public TestContext() throws InvalidServiceProviderException, InvalidSyntaxException, SecuredAccessException,
		...
		instance = new ModelInstanceBuilder(mediator, MyModelInstance.class, ModelConfiguration.class)
				.withStartAtInitializationTime(true).build("serviceProvider", null);
		initialized = true;
