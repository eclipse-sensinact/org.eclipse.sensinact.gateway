...
{		
	public static final String BUILDER_0 = 
			"{\"type\":\"CONDITIONAL\",\"resource\":\"fake\",\"parameter\":\"fake\","
			+ "\"constants\":["
				+ "{\"constant\":100,"
	...
	public void testFactory() throws Exception
	{
		...
		try
        {
			DynamicParameterValueFactory factory = loader.load(mediator, 
				DynamicParameterValue.Type.CONDITIONAL.name());
		   
		   JSONObject jsonBuilder = new JSONObject(DynamicParameterTest.BUILDER_0);
		   DynamicParameterValue trigger = factory.newInstance(
	        	mediator, new Executable<Void,Object>()
	        	{
	        		private int n=0;
