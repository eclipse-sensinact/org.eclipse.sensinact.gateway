...
{		
	...
	{
		<ExtModelConfiguration,ExtModelInstance>this(
		mediator,ExtModelInstance.class, ExtModelConfiguration.class,
		packetType);
	}
	 ...
	 * to which connect the {@link SensiNactResourceModel} to build
	 */
	public  <C extends ExtModelConfiguration,I extends ExtModelInstance<C>> 
	ExtModelInstanceBuilder(Mediator mediator, 
		Class<I> resourceModelType, 
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withProviderImplementationType(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withServiceImplementationType(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withAccessProfile(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withUser(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withResourceImplementationType(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withDefaultResourceType(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withDefaultDataType(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withDefaultModifiable(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withDefaultUpdatePolicy(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withDefaultResourceConfigBuilder(
	 ...
	 */
	@Override
     public ExtModelInstanceBuilder withStartAtInitializationTime(
	 ...
	 */
	@Override
	public ExtModelInstanceBuilder withConfiguration(
	 ...
	 * @return this builder
	 */
	public ExtModelInstanceBuilder withLockedAtInitializationTime(
	 ...
	 * @return this builder
	 */
	public ExtModelInstanceBuilder withConnector(
			Connector<?> connector)
	{
	 ...
	 */
	public ExtModelInstanceBuilder withDesynchronization(
     ...
     */
	@Override
    protected <C extends ModelConfiguration> void 
    configure(C configuration)
    {
    	super.configure(configuration);
    	 ...
    	 if(this.isDesynchronized != null)
    	 {
    		...
    		).setDesynchronized(isDesynchronized);
    	 }
    	 if(this.lockedAtInitializationTime != null)
    	 {
    		 ((ExtModelConfiguration)configuration
    		).setLockedAtInitializationTime(lockedAtInitializationTime);
    	 }
    } 
	...
	{	
		...
		if(super.modelConfiguration != null)
		{ 
			super.buildAccessNode(
				super.modelConfiguration.getAccessTree(), name);
			
			instance = ReflectUtils.<ModelInstance,I>getInstance(
