...
final class IdentifierDefinition extends XmlDefinition
{
     ...
     * 
     * @param encoding
     *      the encoding type of the xml identifier element
     */
     ...
     * 
     * @param identifier
     *            the string representation of the identifier bytes array
     */
    public void setIdentifier(String identifier)
    {
        ...
        if (XmlResourceConfigHandler.STRING_COMMAND_TYPE.equals(this.encoding))
        {
            ...
            {
                this.identifier[i] = (byte) Character.codePointAt(
                        identifierChars, i);
            }
        } else if (XmlResourceConfigHandler.BINARY_COMMAND_TYPE.equals(this.encoding))
        {
            ...
            {
                this.identifier[pos++] = Byte
                        .parseByte(new String(new char[]
                        { identifierChars[i], identifierChars[i + 1] }), 16);
            }
        } else
        {
