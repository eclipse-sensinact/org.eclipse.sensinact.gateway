 ...
 */
@XmlAttributes({@XmlAttribute(attribute = "identifier", field = "serviceProviderIdentifier"),
			    @XmlAttribute(attribute = "profile", field = "serviceProviderProfile")})
public final class DeviceDefinition extends XmlDefinition
{
     ...
     *      the string identifier of this {@link Device} definition
     */
     ...
     * 
     * @return
     *       the array of predefined services'name
     */
    public String[] getServices()
    {
        return this.services.toArray(
                new String[this.services.size()]);
    }
