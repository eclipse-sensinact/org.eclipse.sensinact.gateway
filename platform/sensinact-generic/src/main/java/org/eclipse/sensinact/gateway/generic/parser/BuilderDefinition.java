...
public class BuilderDefinition extends XmlDefinition 
...
{	
     ...
     */
    BuilderDefinition(Mediator mediator, String parameterName, 
    		Attributes atts)
    {
        super(mediator, atts);
     ...
     * 
     * @param subType
     * 		the described CALCULATED {@link DynamicParameterValue}s'
     * 		sub type
     */
     ...
     * 
     * @param reference
     * 		the name of the targeted {@link Resource}
     */
     ...
     * 
     * @param name
     * 		the name of the type of the described {@link 
