...
public final class PolicyDefinition extends XmlDefinition
{
     ...
     * 
     * @param policy
     *      the wrapped {@link ResourceTypeConf}
     */
     ...
     * 
     * @param autoUpdatedStr
     *            string formated boolean value defining whether the
     ...
     * 
     * @param resourceInterfaceDefinition
     * 		the {@link ResourceInterfaceDefinition} to set
     */
     ...
     * 
     * @param resourceClassDefinition
     * 		the {@link ResourceClassDefinition} to set
     */
