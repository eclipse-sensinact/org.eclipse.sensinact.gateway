...
implements StructuredPacket, SubPacket 
{
	...
	private final class PojoPacketExecutable<T> implements Executable<P,T>
	{
		...
		PojoPacketExecutable(String annotated)
		{
			...
			{
				this.annotated = 
					PojoPacketWrapper.class.getDeclaredField(
					annotated);
	 ...
	 */
	private final PojoPacketExecutable<Boolean> iteration =
			new PojoPacketExecutable<Boolean>("iterationAnnotated");
	
	/**
	 * {@link Executable} invoking the @{@link CommandID} annotated
	 * element
	 */
	private final PojoPacketExecutable<Task.CommandType> commandExtractor =
			new PojoPacketExecutable<Task.CommandType>("commandIDAnnotated");
	
	/**
	 * {@link Executable} invoking the @{@link GoodbyeMessage} annotated
	 * element
	 */
	private final PojoPacketExecutable<Boolean> isGoodByeMessageExtractor = 
			new PojoPacketExecutable<Boolean>("goodbyeMessageAnnotated");
	
	/**
	 * {@link Executable} invoking the @{@link HelloMessage} annotated
	 * element
	 */
	private final PojoPacketExecutable<Boolean> isHelloMessageExtractor = 
			new PojoPacketExecutable<Boolean>("helloMessageAnnotated");

	/**
	 * {@link Executable} invoking the @{@link ProfileID} annotated
	 * element
	 */
	private final PojoPacketExecutable<String> profileIdExtractor = 
			new PojoPacketExecutable<String>("profileIDAnnotated");
	
	/**
	 * {@link Executable} invoking the @{@link ServiceProviderID} annotated
	 * element
	 */
	private final PojoPacketExecutable<String> serviceProviderIdExtractor = 
			new PojoPacketExecutable<String>("serviceProviderIDAnnotated");

	/**
	 * {@link Executable} invoking the @{@link ServiceID} annotated
	 * element
	 */
	private final PojoPacketExecutable<String> serviceIdExtractor = 
			new PojoPacketExecutable<String>("serviceIDAnnotated");

	/**
	 * {@link Executable} invoking the @{@link ResourceID} annotated
	 * element
	 */
	private final PojoPacketExecutable<String> resourceIdExtractor = 
			new PojoPacketExecutable<String>("resourceIDAnnotated");
	 ...
	 * element
	 */
	private final PojoPacketExecutable<String> attributeIdExtractor = 
			new PojoPacketExecutable<String>("attributeIDAnnotated");

	/**
	 * {@link Executable} invoking the @{@link MetadataID} annotated
	 * element
	 */
	private final PojoPacketExecutable<String> metadataIdExtractor = 
			new PojoPacketExecutable<String>("metadataIDAnnotated");
	 ...
	 * element
	 */
	private final PojoPacketExecutable<Long> timestampExtractor = 
			new PojoPacketExecutable<Long>("timestampAnnotated");

	/**
	 * {@link Executable} invoking the @{@link Data} annotated
	 * element
	 */
	private final PojoPacketExecutable<Object> dataExtractor = 
			new PojoPacketExecutable<Object>("dataAnnotated");
