...
implements Executable<Task, Object>, Nameable
{
	 ...
	 * Constructor
	 */
	AnnotationExecutor(String target, 
			Task.CommandType commandType,
			TaskCommand.SynchronizationPolicy synchronization,
			boolean isVarArg, 
	...
	public boolean equals(Object object)
	{
		...
		{
			if(((Signature)object).getName().equals(
		...
		if(object.getClass().isArray()
				&& Class.class == object.getClass().getComponentType())
		{
			if(this.isVarArg)
			{
				return true;
			...
			for (; index < length && CastUtils.isAssignableFrom(
					this.parameterTypes[index], parameterTypes[index]) ;
					index++);
    ...
    {
        return TaskCommand.SynchronizationPolicy.SYNCHRONOUS.equals(
     ...
     * 
     * @param profile
     * 		the profile for which to test if this 
     * 		BasisExecutor is registered
     * @return
     * 		true if this BasisExecutor has been
     * 		defined for the profile passed as parameter;
     * 		returns false otherwise
     * 		
     */
     ...
     * 
     * @param profile
     * 		the array profiles for which to test if this 
     * 		BasisExecutor is registered
     * @return
     * 		true if this BasisExecutor has been
    ...
    public String toString()
    {
    	...
    	builder.append(parameterTypes==null
    			?"null":Arrays.toString(parameterTypes));
    	builder.append("\n");
