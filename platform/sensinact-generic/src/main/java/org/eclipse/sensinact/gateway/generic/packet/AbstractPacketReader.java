...
implements PacketReader<P>
{
    ...
    {
    	return Collections.<PayloadFragment>unmodifiableList(
    			this.subPackets).iterator();
    }
    ...
    public Iterator<TaskIdValuePair> getTaskIdValuePairs()
    {
    	...
    	{
    		taskResults.addAll(this.subPackets.get(index
    				).getTaskIdValuePairs());
    	}
     ...
     *  
     * @param packet
     * 		the {@link PayloadFragment} to add
     */
