...
{  
    		...
    		throws InvalidProtocolStackException
    {
	     ...
	     if((this.connector =  manager.<P>connect(this)) != null)
		 {
			Iterator<Map.Entry<String,String>> iterator = 
				manager.getFixedProviders().entrySet().iterator();
			...
			while (iterator.hasNext())
			{
				...
				try
				{
					this.connector.addModelInstance(
     ...
     * 
     * @param commandType
     * 		the {@link CommandType} for which 
     * 		to retrieve the bytes array command
     * @return
     * 		the bytes array command for the specified {@link 
     * 		CommandType}
     */
     ...
     *  
     * @param arrays
     *      the array of bytes arrays to join
     * @param delimiter
     *      the delimiters bytes array
     * @return
     *      the bytes array resulting of the junction
     ...
     * 
     * @param parameter
     *      the parameter object to convert into a bytes array
     * @param delimiter
     *      the array of byte delimiting the distinct elements
     *      of the parameter argument if this last one is of an 
     *      {@link Array} type
     * @return
     *      the parameter argument object converted into a bytes array
     */
    public static byte[] formatParameter(Object parameter, byte[] delimiter)
    {
        ...
        {
            valueBytes = formatParameter(((Parameter)parameter
            		).getValue(), delimiter);
        ...
        } else if(byte.class.equals(parameter.getClass()) || 
