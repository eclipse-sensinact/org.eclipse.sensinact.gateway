...
{	
	 ...
	 * 
	 * @param providers
	 * 		the list of xml  definitions of service providers
	 */
	public FixedProviders(List<DeviceDefinition> providers)
	{
		List<FixedProvider> preProviders =
				new ArrayList<FixedProvider>(); 
		...
		if(providers != null)
		{
			...
			while(iterator.hasNext())
			{
				...
				preProviders.add(new FixedProvider(
						deviceDefinition.getServiceProviderProfile(),
						deviceDefinition.getServiceProviderIdentifier(),
						deviceDefinition.getServices()));
			}
		}				
	...
	public final class FixedProvider implements Iterable<String>, Nameable
	{
		 ...
		 * 
		 * @return
		 * 		this fixed service provider's service names 
		 */
		...
		public Iterator<String> iterator()
		{
			...
			{
				private int pos = 0;
				private final int length = FixedProvider.this.services==null
						?0:FixedProvider.this.services.length;
