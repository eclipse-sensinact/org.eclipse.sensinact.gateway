...
{	    
	 ...
	 * @param processorId
	 *         the targeted {@link PacketProcessor} string
	 *         identifier
	 * @param taskId
	 *         the associated {@link Task} string identifier
	 * @param data
	 *         the embedded data array
	 */
	public MokePacket(Mediator mediator, String processorId, 
		    String taskId, String serviceId, String resourceId ,
		    Object data)
	{
	 ...
	 */
    public MokePacket(Mediator mediator, String processorId,
            String taskId, String[] serviceIds)
    {
		this.mediator = mediator;
		this.processorId = processorId;
	...
	CommandType getCommand()
	{
		if(this.command==null && this.taskId != null)
    	{
    		...
    		String[] taskIdElements = this.taskId.split(
    			new String(new char[]{TaskManager.IDENTIFIER_SEP_CHAR}));
