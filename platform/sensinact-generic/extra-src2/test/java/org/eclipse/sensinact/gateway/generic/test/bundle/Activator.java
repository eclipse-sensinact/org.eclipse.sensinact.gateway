 ...
 * 
 */
public class Activator<C extends ExtModelConfiguration,
I extends ExtModelInstance<C>>
extends AbstractActivator<Mediator>
{
    ...
    {
		this.manager = new ExtModelInstanceBuilder(super.mediator, GenericTestPacket.class
    		...
    		"test-resource.xml", Collections.<String,String>emptyMap());
