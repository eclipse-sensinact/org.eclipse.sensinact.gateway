...
public class TestMathInstaller extends TestCase {
    ...
    public void testAdditionCreation() {
        ...
        try {
            content = TestUtils.readFile(this.getClass().getResourceAsStream("/simple_addition.json"),
    ...
    public void testSubtractionCreation() {
        ...
        try {
            content = TestUtils.readFile(this.getClass().getResourceAsStream("/simple_subtraction.json"),
                    Charset.defaultCharset());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void testMultiplicationCreation() {
        ...
        try {
            content = TestUtils.readFile(this.getClass().getResourceAsStream("/simple_multiplication.json"),
                    Charset.defaultCharset());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void testDivisionCreation() {
        ...
        try {
            content = TestUtils.readFile(this.getClass().getResourceAsStream("/simple_division.json"),
                    Charset.defaultCharset());
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void testModuloCreation() {
        ...
        try {
            content = TestUtils.readFile(this.getClass().getResourceAsStream("/simple_modulo.json"),
                    Charset.defaultCharset());
        } catch (IOException e) {
            e.printStackTrace();
        }
