...
public class TestSnaInstaller extends TestCase {
    ...
    public void testActActionCreation() {
        ...
        try {
            content = TestUtils.readFile(this.getClass().getResourceAsStream("/simple_act_no_parameters.json"),
    ...
    public void testSetActionCreation() {
        ...
        try {
            content = TestUtils.readFile(this.getClass().getResourceAsStream("/simple_set.json"),
                    Charset.defaultCharset());
        } catch (IOException e) {
            e.printStackTrace();
        }
