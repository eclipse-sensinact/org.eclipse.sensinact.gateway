...
class AppJsonSchemaListener implements ServiceListener {
    ...
    private static final String APP_INSTALL_HOOK_FILTER =
            "(objectClass=" + PluginInstaller.class.getCanonicalName() + ")";
    ...
    private JSONArray getJsonSchema() {
        ServiceReference[] serviceReferences = this.mediator
                .getServiceReferences(APP_INSTALL_HOOK_FILTER);
