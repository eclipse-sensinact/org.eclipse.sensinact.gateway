...
class ComponentBuilder {
     ...
     */
    ComponentBuilder(AppServiceMediator mediator, String identifier,
                     AbstractFunction function, List<AppParameter> parameters,
    ...
    public Component build() throws ApplicationFactoryException {
        ...
        return new Component(mediator, identifier, abstractDataListenerMap, function,
                parameters, propertyBlocks, dataProviderMap);
    }
}
