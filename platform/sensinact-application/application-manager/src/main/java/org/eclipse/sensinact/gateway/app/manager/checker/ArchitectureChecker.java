...
public class ArchitectureChecker {
    ...
    public static void checkApplication(String applicationName, List<AppComponent> components)
    ...
    private static List<String> checkUniqueOutput(String applicationName, List<AppComponent> components)
            throws InvalidApplicationException {
    ...
    private static void checkVariableExist(List<AppComponent> components, List<String> identifiers)
            throws  InvalidApplicationException {
            ...
            for(AppParameter parameter : component.getFunction().getRunParameters()) {
                if(parameter.getType().equals("variable")) {
                    if(!identifiers.contains(parameter.getValue())) {
                        throw new InvalidApplicationException("The variable " + parameter.getValue()
                                + " does not exist.");
                    }
                }
            }
