...
implements Runnable
{
	...
	public void push(E element)
	{
		...
		if((maxSize = this.getMaxStackSize())!=UNLIMITED_SIZE
				&& this.length()==maxSize)
		{
			return;
		}
	 ...
	 * 
	 *  @param stackSize
	 *  	the maximum size of the Stack of 
