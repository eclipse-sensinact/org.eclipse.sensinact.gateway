...
public class CryptoUtils
{
    ...
    public static final String cryptWithMD5(String pass) 
     ...
     * 
     * @throws InvalidKeyException
     *      if an error occurred while generating 
     *      a token bytes array
     */
    		...
    		throws InvalidKeyException
    {
        ...
        String token = null;
        String randomNum = new Integer(
               SECURE_RANDOM.nextInt()).toString();
     ...
     *      a public key
     */
    public static final String createToken(String identifier) 
    		throws InvalidKeyException
    {
        if(SECURE_RANDOM == null || SHA1 == null)
        {
    ...
    public static MessageDigest getDigest(String algo)
    {
    	// "SHA1-Digest" should not be necessary. Extensive tests should be
 		...
 		if ("SHA1-Digest".equals(algo) || "SHA-1".equals(algo)
 		        || "SHA1".equals(algo))
 		{
 			return  CryptoUtils.SHA1;
 			
 		} else if ("SHA-256".equals(algo) || "SHA-256-Digest".equals(algo)
 		        || "SHA256".equals(algo))
 		{
 			return CryptoUtils.SHA256;
 			
 		} else if ("MD5".equals(algo) || "MD5-Digest".equals(algo)
 		        || "MD-5".equals(algo))
 		{
