...
{		
	 ...
	 * 		the string filter
	 * @param references
	 * 		the registered {@link ServiceReference}s list
	 */
	 ...
	 *  
	 * @param method
	 * 		the method referenced in the parsed uri  
	 */
	 ...
	 * 
	 * @param className
	 * 		the last referenced OSGi service's
	 * 		class name
	 */
	 ...
	 * 
	 * @return
	 * 		the retrieved method's name in
	 * 		the parsed uri
	 */
	 ...
	 * 
	 * @return
	 * 		 the set of {@link ServiceReference}s as an array
	 * 		retrieved for the key passed as parameter
	 * 
	 */
	public ServiceReference[] get(String key) 
	{
		...
		if(filter != null)
		{
			List<ServiceReference> referencesList  = this.referencesMap.get(
				this.filtersMap.get(key));
