...
{	
	protected static final Logger LOGGER = Logger.getLogger(
			AbstractContentHandler.class.getCanonicalName());
	/**
	 ...
	 * 		the tag's QName
	 * @return
	 * 		a <T> type object build using the ending tag
	 * 
	 * @throws SAXException 
	 */
	 ...
	 * 		the tag's qname
	 * @param atts
	 * 		{@link Attributes} object the starting xml element
	 * @return
	 * 		a <T> type object build using the starting tag
	 * 
	 * @throws SAXException 
	 */
	 ...
	 */
	public void ignorableWhitespace(char[] chrs, int start, int length)
			throws SAXException 
	{
