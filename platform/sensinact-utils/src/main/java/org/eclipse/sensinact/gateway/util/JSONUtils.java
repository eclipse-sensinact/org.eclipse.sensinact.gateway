...
public class JSONUtils 
{
	 ...
	 * 
	 * @param object
	 * 		the {@link Object} to describe as a JSON 
	 * 		formated string
	 * @return
	 ...
	 * 		formated string
	 * @param deep
	 * 		number of possible iterations through the
	 * 		object hierarchy
	 * @return
	 * 		the JSON formated string representation
	 */
	 ...
	 * 
	 * @param object
	 * 		the {@link Object} to return a JSON 
			...
			JSONUtils.JSONWriterContext context)
	{
		...
		{
			return new StringBuilder().append(QUOTE).append(
					object.toString()).append(QUOTE).toString();
		}
		StringBuilder builder = new StringBuilder();
	 ...
	 * 
	 * @param array
	 * 		the {@link array} to represent as a JSON 
	 * 		formated string
	 * @param context
	 ...
	 * 
	 * @param primitive
	 * 		the Primitive object to return the JSON formated
