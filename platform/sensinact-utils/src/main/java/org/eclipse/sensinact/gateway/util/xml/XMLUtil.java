...
public class XMLUtil 
{
	 ...
	 * @throws IOException
	 */
	public static void parse(ContentHandler handler,URL schema,String xml) 
	 ...
	 * @throws IOException
	 */
	public static void parse(ContentHandler handler,URL schema,InputSource xml) 
			throws ParserConfigurationException, SAXException, IOException
	{
		if(handler==null)
		{
	 ...
	 * 		the tag name
	 * @param attributes
	 * 		the tag's attributes array
	 * @param content
	 * 		the text content of the tag to create
	 * @return
	 * 		the XML string formated tag
	 */
	public static String createTag(String prefix,String tag,String[][] attributes,
			Object content)
	{
	 ...
	 * 		Returns the XML string formated tag opening
	 */
	public static String openTag(String prefix,String tag, 
			String[][] attributes)
	{
		StringBuilder tagBuilder = new StringBuilder();
		tagBuilder.append("<");
