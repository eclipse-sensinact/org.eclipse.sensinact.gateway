...
{	
	 ...
	 * to be defined
	 */
	public void setTaskProcessingContextHandler(
			HttpTaskProcessingContextHandler taskProcessingContextHandler)
	{
	 ...
	 * to be set
	 */
	public void setTaskProcessingContextFactory(
			HttpTaskProcessingContextFactory taskProcessingContextFactory)
	{
	 ...
	 * to be set
	 */
	public void setChainedTaskProcessingContextFactory(
		HttpChainedTaskProcessingContextFactory chainedTaskProcessingContextFactory)
	{
	 ...
	 */
	@Override
	public void registerProcessingContext(HttpTask<?,?> key, 
			HttpTaskProcessingContext context)
	{
		if(this.taskProcessingContextHandler == null
				||key == null 
				||context == null)
		{
			return;
		}
		this.taskProcessingContextHandler.registerProcessingContext(
				key, context);
	}
