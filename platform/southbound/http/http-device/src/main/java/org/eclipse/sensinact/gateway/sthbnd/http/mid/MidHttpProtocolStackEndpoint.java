 ...
 */
public abstract class MidHttpProtocolStackEndpoint<RESPONSE extends HttpResponse, 
REQUEST extends MidHttpRequest<RESPONSE>> extends HttpProtocolStackEndpoint 
implements MidClientListener<RESPONSE>
{	
	/**
	 ...
	 * @throws IOException
	 */
    public MidHttpProtocolStackEndpoint(Mediator mediator)
	...
	public void send(Task task)
	{
		...
		{
            MidHttpTask<RESPONSE,REQUEST> httpMidtask =
            		(MidHttpTask<RESPONSE, REQUEST>) task;
