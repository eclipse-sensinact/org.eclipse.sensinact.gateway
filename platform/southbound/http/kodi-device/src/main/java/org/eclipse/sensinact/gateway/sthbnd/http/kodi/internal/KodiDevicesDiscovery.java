...
public class KodiDevicesDiscovery implements SSDPDiscoveryListenerItf {
    ...
    public KodiDevicesDiscovery(Mediator mediator,
    		final SimpleHttpProtocolStackEndpoint connector,
            final String kodiPattern)
    {
    		...
    		new Executable<SSDPDiscoveryNotifierItf,Void>()
		{
			...
			{
				String kodiPattern = (String) KodiDevicesDiscovery.this.mediator.getProperty(
						"kodi.regex");
