...
public class Activator extends MqttActivator {
    ...
    public void doStart() throws Exception {
        ExtModelConfiguration configuration = new ExtModelInstanceBuilder(mediator, MqttPacket.class)
                ...
                .buildConfiguration("mqtt-resource.xml", Collections.emptyMap());

        endPoint = new MqttProtocolStackEndpoint(mediator);

        super.connect(configuration);

        managedServiceFactory = super.mediator.getContext().registerService(ManagedServiceFactory.class,
                new MqttManagedService(super.mediator.getContext()),
        ...
        mqttBusPojoServiceTracker = new ServiceTracker(super.mediator.getContext(),
                Provider.class.getName(),
                new MqttPojoConfigTracker(endPoint, super.mediator.getContext()));
