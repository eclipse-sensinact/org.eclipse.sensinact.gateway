...
public interface FrameType {
     ...
     *
     * @return the length of of the described frame
     */
    int length();
     ...
     *
     * @param length the length of the described frame
     */
     ...
     * described frame
     *
     * @return the implementation class's name of the
     * described frame
     */
    String getClassName();
     ...
     * described frame
     *
     * @param className the implementation class's name of the
     *                  described frame
     */
