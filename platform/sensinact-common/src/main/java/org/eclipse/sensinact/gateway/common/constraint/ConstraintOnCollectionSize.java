...
public abstract class ConstraintOnCollectionSize implements Constraint
{
	...
	protected static final Logger LOGGER = Logger.getLogger(
			ConstraintOnCollectionSize.class.getCanonicalName());
	 ...
	 * 
	 * @param length
	 *            the length of the evaluated collection
	 * @return <ul>
	 ...
	 */
	public ConstraintOnCollectionSize(ClassLoader classloader,
			String operator, int length, boolean complement)
	{
	 ...
	 *            String operator of this constraint
	 * @param length
	 *            value object on which will be based the compliance evaluation
	 *            of the size of a collection
	 * @throws InvalidConstraintDefinitionException
	 *             if the length object cannot be cast into an integer
	 */
	public ConstraintOnCollectionSize(ClassLoader classloader,
			String operator, Object length, 
			boolean complement)
	        throws InvalidConstraintDefinitionException
	{
		this.classloader = classloader;
	...
	public boolean complies(Object value)
	{
		...
		} else
		{
			try
			{
				Object[] array = CastUtils.castArray(
					this.classloader, Object[].class, 
					value);
