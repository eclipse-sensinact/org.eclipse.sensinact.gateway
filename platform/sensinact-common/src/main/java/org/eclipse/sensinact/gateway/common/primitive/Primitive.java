...
{		
	 ...
	 * 
	 * @return 
	 * 		this Primitive's {@link Modifiable} policy
	 */
	 ...
	 * 
	 * @param value 
	 * 		the value being set to this Primitive
	 */
	protected abstract void beforeChange(Object value) 
	 ...
	 * 
	 * @param value 
	 * 		the updated value of the primitive
	 * 
	 * @throws InvalidValueException 
	 */
	protected abstract void afterChange(Object value) 
			throws InvalidValueException;
	 ...
	 * 
	 * @param name
	 *     the name of the Primitive to instantiate
	 * @param type
	 *     the type of the Primitive to instantiate
	 */
	protected Primitive(Mediator mediator, 
	 ...
	 *     the name of the Primitive to instantiate
	 * @param type
	 *     the canonical name of the type of the 
	        ...
	        throws InvalidValueException
	{
		...
		try
		{
			clazz = CastUtils.loadClass(
					mediator.getClassLoader(), type);
			
		} catch(ClassNotFoundException e)
		{
			throw new InvalidValueException(new StringBuilder(
					).append("Invalid type :").append(
							type).toString());
		}
		checkType(clazz);
		this.name = name;
	 ...
	 *     the name of the Primitive to instantiate
	 * @param type
	 *     the type of the Primi  n  tive to instantiate
	 * @param value
	 *     the value of the Primitive to instantiate
	 ...
	 * 
	 * @param jsonObject
	 *     the JSONObject describing the Primitive 
	 *     to instantiate
	 */
	protected Primitive(Mediator mediator, 
	 ...
	 * 
	 * @return 
	 * 		the type of this Primitive or the type 
	 * 		of the linked one
	 */
	 ...
	 * 
	 * @return 
	 * 		the value of this Primitive or a copy of 
	...
	{	    	
		...
		{	
            boolean hasChanged = 
            		((valueObject==null && this.value!=null)
                    || (valueObject!=null 
                    && !valueObject.equals(this.value)));
			...
			throws InvalidValueTypeException
	{
		if (!CastUtils.isPrimitive(type)
		        ...
		        && !type.isEnum()
		        && (!type.isArray() 
		        || !CastUtils.isPrimitive(type.getComponentType())))
		{
			throw new InvalidValueTypeException("Invalid type : "
	 ...
	 * 
	 * @param value
	 *     the value object to cast
	 * @return
	 *     the casted object value
	 * @throws InvalidValueException
	 *         if the value object cannot be cast into the type
	 *         of this Primitive
	 */
