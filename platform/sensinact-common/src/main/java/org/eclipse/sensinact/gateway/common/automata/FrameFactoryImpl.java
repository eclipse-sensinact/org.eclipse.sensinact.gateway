...
public class FrameFactoryImpl implements FrameFactory {
     ...
     *
     * @param classLoader the ClassLoader of the factory
     */
    ...
    public Frame newInstance(FrameModel model) throws FrameException {
        ...
        try {
            ...
            @SuppressWarnings("unchecked") Class<? extends Frame> frameClass = (Class<? extends Frame>) this.classLoader.loadClass(model.getClassName());
