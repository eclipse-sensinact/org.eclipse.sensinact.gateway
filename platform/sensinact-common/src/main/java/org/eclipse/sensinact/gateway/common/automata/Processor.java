...
{	
	 ...
	 * 
	 * @param model
	 * 		the {@link FrameModel} use to create the new 
	 * 		{@link Frame} implementation instance
	 * @return
	 * 		a new empty {@link Frame}
	 * 
	 * @throws FrameProcessorException 
	 * @throws FrameException 
	 */
	Frame newFrame(FrameModel model) 
			throws FrameProcessorException, FrameException;
	 ...
	 * 
	 * @return
	 * 		a new {@link FrameModel}
	 * 
	 * @throws FrameModelException 
	 */
	FrameModelHandler newModel(String xmlModelPath) 
			throws FrameModelException;
	 ...
	 * 
	 * @return
	 * 		the array of bytes used to delimit a frame
	 * 
	 * @throws FrameModelException 
	 */
	byte[] getDelimiters();
