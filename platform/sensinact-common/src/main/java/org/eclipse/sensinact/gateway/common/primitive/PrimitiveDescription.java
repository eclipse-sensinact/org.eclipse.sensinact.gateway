...
public abstract class PrimitiveDescription implements Description, Nameable
{
	 ...
	 * 
     * @param uri
     *      the string uri of the described {@link Primitive}
     * @param name
     *      the name of the described {@link Primitive}
     * @param type
     *      the type of the described {@link Primitive}
     * @param modifiable
     *      Is the value of the described {@link Primitive} modifiable ?
     */
    protected PrimitiveDescription(String name, 
            Class<?> type, Modifiable modifiable)
    {
        this.name = name;
        this.type = type;
	...
	/**
	 * @param primitive
	 *      the {@link Primitive} to describe
	 */
	...
	public String getJSON()
	{
		...
		description.put(VALUE_KEY,this.toJson(
	...
	protected final JSONObject getJSONObject()
	{
		...
		String typeName = CastUtils.writeClass(
				this.getType());
	 ...
	 * 
	 * @return 
	 * 		the described Primitive's {@link Modifiable} 
	 * 		policy
	 */
	 ...
	 * 
	 * @param type
	 * 		the type of the value object to cast
	 * @param value
	 * 		the object value to convert into a 
	 * 		JSON formated one
	 * @return
	 * 		the JSON formated object value 
	 */
