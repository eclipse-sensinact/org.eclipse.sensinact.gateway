 ...
 * 
 * @param <P>
 * 		the wrapped executor parameter type
 * @param <V>
 * 		the wrapped executor returned type
 * 
...
public interface ExecutionContext<P,V>
{
	 ...
	 * 
	 * @return
	 * 		this ExecutionContext's  {@link ExecutionErrorHandler}
	 */
	 ...
	 * 
	 * @return
	 * 		this ExecutionContext's {@link Executable}
	 */
	 ...
	 * 
	 * @return
	 * 		the <code>&lt;P&gt;</code> typed parameter to
