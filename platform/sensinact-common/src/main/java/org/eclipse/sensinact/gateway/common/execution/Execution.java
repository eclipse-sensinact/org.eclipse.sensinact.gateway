...
public interface Execution 
{
	...
	enum ExecutionParameterizingPolicy
	{
		...
		//SnaExecutors are parameterized using a dedicated
		//set of parameters
		DISTINCT_PARAMETERS,
		//The result returned by an SnaExecutor becomes the 
	 ...
	 * 
	 * @return
	 * 		this Execution's ExecutionParameterizingPolicy
	 */
	 ...
	 * 
	 * @return
	 * 		this Execution's ExecutionResultPolicy
	 */
	 ...
	 * 
	 * @param parameters
	 * 		the initial variable set of object parameters
	 */
	 ...
	 * 	  
	 * @param parameters
	 * 		the variable set of object parameters
	 */
	 ...
	 * 
	 * @return
	 * 		this Execution processing result
	 */
	Object getResult();
