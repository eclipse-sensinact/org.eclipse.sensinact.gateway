...
public interface Frame {
     ...
     *
     * @return this frame's bytes array
     */
    byte[] getBytes();
     ...
     *
     * @param bte the byte value to set
     ...
     *
     * @param length the length of this frame
     */
     ...
     * parent's onec c
     *
     * @param length the offset of this frame in its parent's
     *               bytes array
     */
     ...
     *
     * @param child the Frame child to add
     */
     ...
     *
     * @return the array of Frame children
     */
    Frame[] getChildren();
