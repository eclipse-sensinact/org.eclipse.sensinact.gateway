                ...
                if(annotation!=null) {
                    ...
                    if(!annotation.validationRegex().trim().equals("") && value!=null) {
                        ...
                        if(!patternValidation.matcher(value.toString()).matches()) {
                            LOG.log(Level.SEVERE,String.format("field value %s, on field {}, is invalid with respect to the regex %s required",
                    ...
                    if(value != null) {
                        try {
                            ...
                            LOG.log(Level.SEVERE,String.format("value %s could not be inject on field %s of the type %s in POJO %s",
