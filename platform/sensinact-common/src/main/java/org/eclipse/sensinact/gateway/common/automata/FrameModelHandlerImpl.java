 ...
 */
public  class FrameModelHandlerImpl extends AbstractContentHandler<FrameType>
implements FrameModelHandler 
{	
	...
	static 
	{
		String[] endMethodsNames = new String[]{
				"nameEnd",
				"lengthEnd",
				"implementationEnd",
				"typesEnd",
		...
		String[] startMethodsNames = new String[]{
				"typeStart",
				"framesStart",
				"frameStart"
				};
		...
		try
		{
			...
			{
				method = FrameModelHandlerImpl.class.getDeclaredMethod(
					methodName,new Class[]{Attributes.class});				
	...
	public FrameType frameStart(Attributes atts) throws FrameModelException
	{
		...
		if(type != null)
		{
			FrameModel frameModel = FrameModelImpl.newInstance(
					this.mediator,atts,type);
