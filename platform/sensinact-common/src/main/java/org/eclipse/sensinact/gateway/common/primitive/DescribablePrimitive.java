...
extends Primitive implements Describable
{		
	/**
	 ...
	 * 
	 * @return 
	 * 		a {@link PrimitiveDescription} of this 
	 ...
	 */
	protected DescribablePrimitive(Mediator mediator, 
	 ...
	 */
	@Override
    public void afterChange(Object value) 
    		throws InvalidValueException
	{
	...
	public <D extends Description> D getDescription()
	{
		...
		if(this.weakDescription==null || (description =
			(D) this.weakDescription.get())== null)
		{				
			description = (D)this.createDescription();	
			this.weakDescription = new WeakDescription(
