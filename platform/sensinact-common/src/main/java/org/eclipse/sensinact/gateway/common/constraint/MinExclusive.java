...
public class MinExclusive<T> extends ConstraintOnComparable<T> {
     ...
     */
    public MinExclusive(ClassLoader classloader, Class<T> operandClass, Object operand, boolean complement) throws InvalidConstraintDefinitionException {
    ...
    public Constraint getComplement() {
        MinExclusive complement = null;
        try {
            complement = new MinExclusive(super.classloader, (Class<Comparable<T>>) super.operand.getClass(), super.operand, !this.complement);
