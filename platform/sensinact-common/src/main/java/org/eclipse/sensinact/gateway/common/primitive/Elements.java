...
implements Nameable, PathElement
{	
	/**
	 ...
	 * 
	 * @param mediator
	 * 		the {@link Mediator} that will allow the 
 	 *		Elements to instantiate to interact with the OSGi 
 	 *		host environment
	 * @param uri
	 * 		the string uri path of the Elements
	 * 		to instantiate
	 */
     ...
     * 
     * @return
     * 		this <code>&lt;P&gt;</code> typed elements 
     * 		collection length
     */
    public int length()
    {
     ...
     * 
     * @return
     * 		the specified <code>&lt;P&gt;</code> typed 
     * 		owned object
     */
     ...
     * @return
     * 		the specified indexed <code>&lt;P&gt;</code> 
     * 		typed owned object
     */
     ...
     * 
     * @param element
     * 		the <code>&lt;P&gt;</code> typed object to add
     */
     ...
     * 
     * @param element
     * 		the name of the <code>&lt;P&gt;</code> typed object
     * 		to remove     * 
     * @return 
     * 		the removed <code>&lt;P&gt;</code> typed object
     */
   	public P removeElement(String element) 
   	{
   		...
   		{
   			int index = -1;
   			if((index = this.elements.indexOf(
   				new Name<Description>(element)))>-1)
   			{  
     ...
     * 
     * @param index
     * 		the index of the <code>&lt;P&gt;</code> typed 
     * 		object to remove
     * @return 
     * 		the removed <code>&lt;P&gt;</code> typed object
     */
	 ...
	 * 
	 * @return
	 * 		the last retrieved {@link Elements} instance
	...
	public <O> O search(String uri)
	{
   	 ...
   	 * @throws Exception
   	 */
   	public void forEach(Executable<P, Void> executor) 
   			throws Exception
   	{
   		synchronized(this.elements)
   		{
     ...
     * 
     * @return
     * 		the {@link Enumeration} of the <code>&lt;P&gt;</code> 
    ...
    {
    	int position = 0;
    	Object[] elementArray = Elements.this.elements.toArray(
    			new Object[0]);
