...
extends Describable, PathElement
{
	 ...
	 *
	 * @param name
	 * 		the name of the searched &lt;P&gt; typed element
	 * @return
	 * 		the specified  &lt;P&gt; typed element held by this 
	 *      ElementsProxy
	 */
	 ...
	 *
	 * @return
	 * 		this ElementsProxy's elements {@link Enumeration} 
	 */ 
	 ...
	 * 
	 * @return
	 * 		<ul><li>true if the {@link Elements} proxied by
