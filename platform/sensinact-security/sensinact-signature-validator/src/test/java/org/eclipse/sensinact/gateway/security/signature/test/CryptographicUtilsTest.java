...
public class CryptographicUtilsTest
{
	...
	KeyStore getKeyStore() throws KeyStoreException, FileNotFoundException,
	 ...
	 */
	String getTrueHashValue(byte[] data, String algo)
	        throws NoSuchAlgorithmException
	{
	...
	public void testCheckHashValueOK() throws Exception
	{
		...
		boolean result = cutils.checkHashValue(data, trueHashValue,
		        "SHA1-Digest");;
	...
	{
		byte[] data = getData(fileName4hash);
		boolean result = cutils.checkHashValue(data, falseHashValue,
		        "SHA1-Digest");;
	...
	public void testCheckCMSDataValidity() throws Exception
	{
		try
		{
			...
			boolean res = cutils.checkCMSDataValidity(signatureFileData,
			        signatureBlockData, "SHA1-Digest");
