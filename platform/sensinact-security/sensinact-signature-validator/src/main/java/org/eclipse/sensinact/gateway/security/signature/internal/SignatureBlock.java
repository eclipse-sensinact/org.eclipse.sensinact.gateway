...
public class SignatureBlock extends CMSSignedData
{
	...
	public SignatureBlock(Mediator mediator, URL url)
	 ...
	 * @throws IOException
	 */
	public static SignatureBlock getInstance(Mediator mediator,
	        SignedBundle sjar, String signerName)
	...
	{
		final Iterator<SignerInformation> iter =  pkcs7.getSignerInfos(
				).getSigners().iterator();
