...
public class SignedBundleManifest extends Manifest
{
	...
	public SignedBundleManifest(Mediator mediator, InputStream iStream,
	        CryptographicUtils cryptoUtils) throws IOException
	{
		super(iStream);
	 ...
	 */
	public static byte[] getManifestMainAttributesAsBytes(
	...
	public static byte[] getManifestMainAttributesAsBytes(final byte[] rawData)
	        throws IOException
	{
	...
	public static byte[] getManifestMainAttributesAsBytes(
	        Mediator mediator, InputStream manifestInputStream)
	        throws IOException
	{
		// get manifest data
