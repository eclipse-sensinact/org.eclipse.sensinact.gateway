...
public class SignatureFile
{
	...
	protected final Attributes getMainAttributes(final InputStream iStream)
	        throws IOException
	{
	...
	protected final Map<String, Attributes> getEntries(
	...
	public String getManifestHash()
	{
		...
		{
			this.mediator.debug("Looking for Manifest hash header [%s]", 
					this.hashHeader);
		}
	...
	public void show()
	{
		...
		String value;
		// mainAttributes
		for (final Iterator iter = mainAttributes.entrySet().iterator();
				iter.hasNext();)
		{
		...
		// resourcesEntries
		for (final Iterator iter = resourcesEntries.entrySet().iterator();
				iter.hasNext();)
		{

			entry = (Map.Entry) iter.next();
			value = (String) ((Map.Entry) ((Attributes) entry.getValue())
