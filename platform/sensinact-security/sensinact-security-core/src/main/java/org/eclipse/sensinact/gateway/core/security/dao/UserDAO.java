...
public class UserDAO extends AbstractMutableSnaDAO<UserEntity> {
     ...
     * @return the {@link UserEntity} from the datastore matching
     * the given Long identifier, otherwise null.
     * @throws DAOException If something fails at datastore level.
     */
    public UserEntity find(final long identifier) throws DAOException {
     ...
     * matching the given Long identifier, otherwise null.
     *
     * @param login    The string login of the {@link UserEntity} to be returned.
     * @param password The MD5 encoded string password of the {@link UserEntity}
     *                 to be returned.
     * @return the {@link UserEntity} from the datastore matching
     * the given login and password, otherwise null.
     * @throws DAOException If something fails at datastore level.
     */
    public UserEntity find(final String login, final String password) throws DAOException {
        List<UserEntity> userEntities = super.select(new HashMap<String, Object>() {{
     ...
     *
     * @param publicKey The String public key of the {@link UserEntity} to
     *                  be returned.
     * @return the {@link UserEntity} from the datastore matching
     * the given Long identifier, otherwise null.
     * @throws DAOException If something fails at datastore level.
     */
    public UserEntity find(final String publicKey) throws DAOException {
        List<UserEntity> userEntities = super.select(new HashMap<String, Object>() {{
