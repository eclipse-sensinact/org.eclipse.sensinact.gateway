...
public class ApplicationDAO extends AbstractMutableSnaDAO<ApplicationEntity> {
     ...
     * @return the {@link ApplicationEntity} from the datastore matching
     * the given Long identifier, otherwise null.
     * @throws DAOException If something fails at datastore level.
     */
    public ApplicationEntity find(final long identifier) throws DAOException {
     ...
     *
     * @param publicKey The String public key of the {@link ApplicationEntity} to
     *                  be returned.
     * @return the {@link ApplicationEntity} from the datastore matching
     * the given String public key, otherwise null.
     * @throws DAOException If something fails at datastore level.
     */
    public ApplicationEntity findFromPublicKey(final String publicKey) throws DAOException {
        if (publicKey == null) {
            return null;
        }
        List<ApplicationEntity> applicationEntities = super.select(new HashMap<String, Object>() {{
     ...
     *
     * @param privateKey The String private key of the {@link ApplicationEntity} to
     *                   be returned.
     * @return the {@link ApplicationEntity} from the datastore matching
     * the given String private key, otherwise null.
     * @throws DAOException If something fails at datastore level.
     */
    public ApplicationEntity findFromPrivateKey(final String privateKey) throws DAOException {
        if (privateKey == null) {
            return null;
        }
        List<ApplicationEntity> applicationEntities = super.select(new HashMap<String, Object>() {{
