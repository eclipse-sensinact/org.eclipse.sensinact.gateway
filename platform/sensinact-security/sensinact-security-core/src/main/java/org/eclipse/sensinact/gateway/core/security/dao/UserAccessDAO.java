...
public class UserAccessDAO extends AbstractImmutableSnaDAO<UserAccessEntity> {
     ...
     *                   to be returned.
     * @return the {@link UserAccessEntity} from the datastore matching
     * the given long identifier, otherwise null.
     * @throws DAOException
     */
    public UserAccessEntity find(final long identifier) throws DAOException {
     ...
     * @throws DAOException
     */
    public UserAccessEntity find(final String name) throws DAOException {
        List<UserAccessEntity> userAccessEntities = super.select(new HashMap<String, Object>() {{
     ...
     */
    public UserAccessEntity find(final int level) throws DAOException {
        List<UserAccessEntity> userAccessEntities = super.select(new HashMap<String, Object>() {{
