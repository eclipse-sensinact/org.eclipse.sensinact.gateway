...
public class AuthenticatedDAO extends AbstractMutableSnaDAO<AuthenticatedEntity> {
     ...
     */
    public AuthenticatedEntity findFromUser(String path, long uid) throws DAOException {
     ...
     * @throws DAOException If something fails at datastore level.
     */
    public AuthenticatedEntity findFromAgent(String path, long aid) throws DAOException {
        AuthenticatedEntity entity = null;
     ...
     * @throws DAOException If something fails at datastore level.
     */
    public AuthenticatedEntity findFromApplication(String path, long appid) throws DAOException {
        AuthenticatedEntity entity = null;
     ...
     * @throws DAOException If something fails at datastore level.
     */
    public AuthenticatedEntity find(String path, final String publicKey) throws DAOException {
