...
public class AuthenticatedAccessLevelDAO extends AbstractImmutableSnaDAO<AuthenticatedAccessLevelEntity> {
     ...
     * @throws DAOException
     */
    protected AuthenticatedAccessLevelEntity find(final long objectIdentifier, final String publicKey) throws DAOException {
     ...
     * @throws DAOException
     */
    protected AuthenticatedAccessLevelEntity find(final long objectIdentifier, final long userIdentifier) throws DAOException {
        List<AuthenticatedAccessLevelEntity> userAccessLevelEntities = super.select(new HashMap<String, Object>() {{
            this.put("UOID", objectIdentifier);
     ...
     * @throws DAOException
     */
    public AuthenticatedAccessLevelEntity find(String path, String publicKey) throws DAOException {
     ...
     * @throws DAOException
     */
    public AuthenticatedAccessLevelEntity find(String path, long identifier) throws DAOException {
        ObjectEntity objectEntity = null;
        List<ObjectEntity> objectEntities = this.objectDAO.find(path);
        if (objectEntities.size() > 0) {
            objectEntity = objectEntities.get(0);
