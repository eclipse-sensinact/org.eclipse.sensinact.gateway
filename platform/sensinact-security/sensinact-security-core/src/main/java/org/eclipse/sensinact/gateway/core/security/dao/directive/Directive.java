...
public abstract class Directive 
{
	 ...
	 * @param entry
	 */
	protected void buildEqualityDirective(StringBuilder builder, 
			Map.Entry<String, Object> entry)
	{
		this.buildEqualityDirective(builder, 
				entry.getKey(), 
				entry.getValue());
	}
	...
	protected String getColumnName(String column)
	{
		...
		if(columnElements.length == 2 
				&& this.table.equals(columnElements[0]))
		{
			return column;
		}
