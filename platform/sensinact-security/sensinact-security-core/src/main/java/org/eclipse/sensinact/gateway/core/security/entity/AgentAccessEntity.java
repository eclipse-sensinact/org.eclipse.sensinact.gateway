 ...
 */
@Table(value = "AGENT_ACCESS")
@PrimaryKey(value = {"APUBLIC_KEY","OID","UAID"})
public class AgentAccessEntity extends SnaEntity
{
	@NotNull
	@Column(value = "APUBLIC_KEY")
	@ForeignKey(refer = "APUBLIC_KEY", table = "AGENT")
	 ...
	 */
	public AgentAccessEntity(Mediator mediator)
	{
		super(mediator);
	}
