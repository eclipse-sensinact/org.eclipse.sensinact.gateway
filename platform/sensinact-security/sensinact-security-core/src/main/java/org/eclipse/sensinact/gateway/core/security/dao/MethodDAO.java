...
public class MethodDAO extends AbstractImmutableSnaDAO<MethodEntity>
{
     ...
     * @return 
     * 		the {@link MethodEntity} from the datastore matching 
     * 		the given Long identifier, otherwise null.
     * 
     * @throws DAOException If something fails at datastore level.
     */
    public MethodEntity find(final long identifier) 
    		throws DAOException
    {
    	List<MethodEntity> methodEntities = super.select(
     ...
     * method name.
     */
	public MethodEntity find(final String methodName) 
			throws DAOException
    {
    	List<MethodEntity> methodEntities = super.select(
    		new HashMap<String, Object>(){{this.put(
