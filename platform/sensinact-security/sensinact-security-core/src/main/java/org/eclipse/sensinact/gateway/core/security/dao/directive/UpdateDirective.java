...
public class UpdateDirective extends Directive
{
	 ...
	 * @return
	 */
	public static <E extends SnaEntity> UpdateDirective 
	getUpdateDirective(Mediator mediator, E entity)
	{		
		...
		KeyDirective keyDirective = KeyDirective.createKeyDirective(mediator,
			table, primaryKey, fields);
		keyDirective.assign(entity);
		
		UpdateDirective updateDirective = new UpdateDirective(mediator, 
		...
		while(iterator.hasNext())
		{
			...
			updateDirective.update(entry.getValue().value(), 
	 ...
	 * Constructor
	 */
	public UpdateDirective(Mediator mediator, 
			String table, KeyDirective keyDirective)
	{
