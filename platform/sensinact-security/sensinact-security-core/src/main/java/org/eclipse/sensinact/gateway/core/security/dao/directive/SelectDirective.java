...
public class SelectDirective extends Directive {
	...
	/**
	 * Joins the SelectDirective passed as parameter to this one
	 * 
	...
	/**
	 * Joins the KeyDirective passed as parameter to this SelectDirective
	 * 
	 * @param keyDirective
	 *            the KeyDirective to join to this SelectDirective
	 */
	...
	public String toString() {
		...
		String selectStatement = selectBuilder.append(fromBuilder.toString()).append(whereBuilder.toString())
				.toString();
