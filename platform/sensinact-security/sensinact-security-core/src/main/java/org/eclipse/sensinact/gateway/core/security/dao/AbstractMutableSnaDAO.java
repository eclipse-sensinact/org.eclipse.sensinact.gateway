...
extends AbstractSnaDAO<E>
{
	 ...
	 * @throws DAOException 
	 */
	AbstractMutableSnaDAO(Mediator mediator, Class<E> entityType) 
			throws DAOException
	{
	 ...
	 *
	 * @see AbstractSnaDAO#
	 * created(SnaEntity, java.lang.Long)
	 */
	@Override
	void created(E entity, long identifier)
	{
		...
		{
			mediator.debug("new %s record in the datastore", 
			entityType.getSimpleName());
			
		} else
		{		
			mediator.debug("Unable to define the new entity '%s' identifier [%s]",
	 ...
	 *
	 * @see AbstractSnaDAO#
	 * updated(java.lang.Integer)
	 */
	@Override
	void updated(int records)
	{
		super.mediator.debug("%s %s record(s) updated in the datastore", 
			records, entityType.getSimpleName());
	}
	 ...
	 *
	 * @see AbstractSnaDAO#
	 * deleted(java.lang.Integer)
	 */
	@Override
	void deleted(int records)
	{
		super.mediator.debug("%s %s record(s) deleted in the datastore", 
			records, entityType.getSimpleName());
	}
}
