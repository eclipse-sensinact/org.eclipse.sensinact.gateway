...
public class ObjectDAO extends AbstractMutableSnaDAO<ObjectEntity> {
    ...
    public ObjectDAO(Mediator mediator) throws DAOException {
        ...
        super.registerUserDefinedSelectStatement("getObjectFromPath", new UserDefinedSelectStatement(mediator, "script/getObjectFromPath.sql"));
    }
     ...
     * @throws DAOException
     */
    public List<ObjectEntity> find(String path, boolean exact) throws DAOException {
        ...
        while (!objectEntities.isEmpty()) {
            ...
            String[] objectPathElements = (objectPath != null) ? UriUtils.getUriElements(objectPath.replace(PathNode.ANY_REGEX, PathNode.ANY_REPLACEMENT)) : new String[0];
            ...
            if (uriElements.length == objectPathElements.length) {
                ...
                try {
                    if (lastFound.equals(PathNode.ANY_REPLACEMENT) || lastSearched.equals(lastFound) || Pattern.matches(lastFound, lastSearched)) {
                        filtered.add(tmpEntity);
                    }
     ...
     * @throws DAOException
     */
    public List<ObjectEntity> findChildren(final long identifier) throws DAOException {
