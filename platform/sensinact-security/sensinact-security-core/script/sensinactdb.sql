...
SULOGIN VARCHAR NOT NULL, SUPASSWORD VARCHAR NOT NULL, SUMAIL VARCHAR, 
...
--passwd : anonymous
INSERT INTO SNAUSER VALUES (0, "ANONYMOUS",  "294de3557d9d0b3d2d8a1e6aab028cf", "anonymous", "anonymous");

DROP TABLE IF EXISTS AUTHENTICATED ; 
CREATE TABLE AUTHENTICATED (
SUPUBLIC_KEY BIGINT NOT NULL, 
OID BIGINT NOT NULL, 
UAID BIGINT NOT NULL, 
PRIMARY KEY (SUPUBLIC_KEY,  OID),
FOREIGN KEY (SUPUBLIC_KEY) REFERENCES SNAUSER (SUPUBLIC_KEY),
...
ON OBJECT
BEGIN 
 INSERT INTO AUTHENTICATED (SUPUBLIC_KEY, OID, UAID) VALUES ("anonymous",new.OID, 2);
END;

DROP TABLE IF EXISTS AGENT_ACCESS ; 
CREATE TABLE AGENT_ACCESS (
APUBLIC_KEY BIGINT NOT NULL, 
OID BIGINT NOT NULL, 
UAID BIGINT NOT NULL, 
PRIMARY KEY (APUBLIC_KEY,  OID),
FOREIGN KEY (APUBLIC_KEY) REFERENCES AGENT (APUBLIC_KEY),
FOREIGN KEY (OID) REFERENCES OBJECT (OID),
FOREIGN KEY (UAID) REFERENCES USER_ACCESS (UAID));  

-- METHOD ACCESSIBILITY BY USER ACCESS LEVEL, OBJECT AND METHOD
--DROP VIEW IF EXISTS METHOD_ACCESSIBILITY; 
--CREATE VIEW METHOD_ACCESSIBILITY AS
--SELECT USER_ACCESS.UAID, USER_ACCESS.UANAME, USER_ACCESS.UALEVEL, OBJECT_ACCESS.OANAME, 
--OBJECT_ACCESS.OALEVEL, OBJECT.OID, METHOD.MID, METHOD.MNAME, 
--CASE WHEN OBJECT_ACCESS.OALEVEL > USER_ACCESS.UALEVEL THEN 0 ELSE 1 END AS ACCESSIBLE
--FROM OBJECT, OBJECT_PROFILE, OBJECT_PROFILE_ACCESS, METHOD, USER_ACCESS, OBJECT_ACCESS
--WHERE OBJECT.OPID=OBJECT_PROFILE_ACCESS.OPID
--AND OBJECT_PROFILE.OPID=OBJECT_PROFILE_ACCESS.OPID
--AND METHOD.MID=OBJECT_PROFILE_ACCESS.MID
--AND OBJECT_ACCESS.OAID=OBJECT_PROFILE_ACCESS.OAID;

-- USER ACCESS LEVEL BY OBJECT
DROP VIEW IF EXISTS USER_ACCESS_LEVEL ; 
CREATE VIEW USER_ACCESS_LEVEL AS
SELECT AUTHENTICATED.OID, AUTHENTICATED.SUPUBLIC_KEY, SNAUSER.SUID, 
USER_ACCESS.UAID, USER_ACCESS.UALEVEL
FROM OBJECT, SNAUSER, AUTHENTICATED, USER_ACCESS
WHERE AUTHENTICATED.SUPUBLIC_KEY=SNAUSER.SUPUBLIC_KEY 
AND AUTHENTICATED.OID=OBJECT.OID
AND USER_ACCESS.UAID=AUTHENTICATED.UAID 
UNION ALL
SELECT OBJECT.OID AS MYOID, SNAUSER.SUPUBLIC_KEY AS MYPK, SNAUSER.SUID,
CASE WHEN OBJECT.SAUTH = 1 THEN 3 ELSE 2 END AS MYUAID,
CASE WHEN OBJECT.SAUTH = 1 THEN 2 ELSE 1 END AS MYUALEVEL
FROM OBJECT, SNAUSER
WHERE 
(SELECT COUNT(AUTHENTICATED.OID) FROM AUTHENTICATED 
 WHERE AUTHENTICATED.OID = MYOID 
AND AUTHENTICATED.SUPUBLIC_KEY = MYPK) = 0
AND SNAUSER.SUID != 0;

-- AGENT ACCESS LEVEL BY OBJECT
DROP VIEW IF EXISTS AGENT_ACCESS_LEVEL ; 
CREATE VIEW AGENT_ACCESS_LEVEL AS
SELECT AGENT_ACCESS.OID, AGENT_ACCESS.APUBLIC_KEY, AGENT.AID,  
USER_ACCESS.UAID, USER_ACCESS.UALEVEL
FROM OBJECT, AGENT, AGENT_ACCESS, USER_ACCESS
WHERE AGENT_ACCESS.APUBLIC_KEY=AGENT.APUBLIC_KEY 
AND AGENT_ACCESS.OID=OBJECT.OID
AND USER_ACCESS.UAID=AGENT_ACCESS.UAID
UNION ALL
SELECT OBJECT.OID AS MYOID, AGENT.APUBLIC_KEY AS MYPK, AGENT.AID,
CASE WHEN OBJECT.SAUTH = 1 THEN 3 ELSE 2 END AS MYUAID,
CASE WHEN OBJECT.SAUTH = 1 THEN 2 ELSE 1 END AS MYUALEVEL
FROM OBJECT, AGENT
WHERE 
(SELECT COUNT(AGENT_ACCESS.OID) FROM AGENT_ACCESS 
 WHERE AGENT_ACCESS.OID = MYOID 
AND AGENT_ACCESS.APUBLIC_KEY = MYPK) = 0;

-- USER ACCESSIBILITY BY OBJECT AND METHOD
--DROP VIEW IF EXISTS USER_ACCESSIBILITY ; 
--CREATE VIEW USER_ACCESSIBILITY AS
--SELECT AUTHENTICATED.OID, AUTHENTICATED.SUPUBLIC_KEY, SNAUSER.SUID, METHOD.MNAME,
--CASE WHEN OBJECT_ACCESS.OALEVEL > USER_ACCESS.UALEVEL THEN 0 ELSE 1 END AS ACCESSIBLE
--FROM OBJECT, SNAUSER, AUTHENTICATED, OBJECT_PROFILE, OBJECT_PROFILE_ACCESS, METHOD,
--USER_ACCESS, OBJECT_ACCESS
--WHERE AUTHENTICATED.SUPUBLIC_KEY=SNAUSER.SUPUBLIC_KEY 
--AND AUTHENTICATED.OID=OBJECT.OID
--AND OBJECT.OPID=OBJECT_PROFILE_ACCESS.OPID
--AND OBJECT_PROFILE.OPID=OBJECT_PROFILE_ACCESS.OPID
--AND METHOD.MID=OBJECT_PROFILE_ACCESS.MID
--AND USER_ACCESS.UAID=AUTHENTICATED.UAID
--AND OBJECT_ACCESS.OAID=OBJECT_PROFILE_ACCESS.OAID 
--UNION ALL
--SELECT OBJECT.OID AS MYOID, SNAUSER.SUPUBLIC_KEY AS MYPK, SNAUSER.SUID, METHOD.MNAME,
--CASE WHEN ((OBJECT_ACCESS.OALEVEL > 2 AND OBJECT.SAUTH == 1)
--OR (OBJECT_ACCESS.OALEVEL > 1 AND OBJECT.SAUTH == 0)) THEN 0 ELSE 1 END AS ACCESSIBLE
--FROM OBJECT, SNAUSER, OBJECT_PROFILE, OBJECT_PROFILE_ACCESS, METHOD, OBJECT_ACCESS
--WHERE 
--(SELECT COUNT(AUTHENTICATED.OID) FROM AUTHENTICATED 
-- WHERE AUTHENTICATED.OID = MYOID 
--AND AUTHENTICATED.SUPUBLIC_KEY = MYPK) = 0
...
-- AGENT ACCESSIBILITY BY OBJECT AND METHOD
--DROP VIEW IF EXISTS AGENT_ACCESSIBILITY ; 
--CREATE VIEW AGENT_ACCESSIBILITY AS
--SELECT AGENT_ACCESS.OID, AGENT_ACCESS.APUBLIC_KEY, AGENT.AID, METHOD.MNAME,
--CASE WHEN OBJECT_ACCESS.OALEVEL > USER_ACCESS.UALEVEL THEN 0 ELSE 1 END AS ACCESSIBLE
--FROM OBJECT, AGENT, AGENT_ACCESS, OBJECT_PROFILE, OBJECT_PROFILE_ACCESS, METHOD,
--USER_ACCESS, OBJECT_ACCESS
--WHERE AGENT_ACCESS.APUBLIC_KEY=AGENT.APUBLIC_KEY 
--AND AGENT_ACCESS.OID=OBJECT.OID
--AND OBJECT.OPID=OBJECT_PROFILE_ACCESS.OPID
...
--AND OBJECT_ACCESS.OAID=OBJECT_PROFILE_ACCESS.OAID
--UNION ALL
--SELECT OBJECT.OID AS MYOID, AGENT.APUBLIC_KEY AS MYPK, AGENT.AID, METHOD.MNAME,
--CASE WHEN ((OBJECT_ACCESS.OALEVEL > 2 AND OBJECT.SAUTH == 1)
--OR (OBJECT_ACCESS.OALEVEL > 1 AND OBJECT.SAUTH == 0)) THEN 0 ELSE 1 END AS ACCESSIBLE
--FROM OBJECT, AGENT, OBJECT_PROFILE, OBJECT_PROFILE_ACCESS, METHOD, OBJECT_ACCESS
--WHERE 
--(SELECT COUNT(AGENT_ACCESS.OID) FROM AGENT_ACCESS 
-- WHERE AGENT_ACCESS.OID = MYOID 
--AND AGENT_ACCESS.APUBLIC_KEY = MYPK) = 0
...
-- OBJECT WITH PATH VIEW
--DROP VIEW IF EXISTS OBJECT_WITH_PATH ; 
--CREATE VIEW OBJECT_WITH_PATH AS
...
--	FROM OBJECT
--    UNION ALL
--    SELECT child_object.FIRST, parent_object.OID, parent_object.NAME as PATH_ELEMENT, parent_object.PARENT
...
FOR EACH ROW
BEGIN
    SELECT RAISE(ABORT, 'Object must be unique according to the key [name - parent] ')
...
FOR EACH ROW 
BEGIN 
	DELETE FROM AUTHENTICATED WHERE 
	OID IN (
	...
	DELETE FROM AGENT_ACCESS WHERE 
	OID IN (
	WITH RECURSIVE ALL_OBJECTS (OID) AS
	(
		SELECT OLD.OID 
...
FOR EACH ROW
BEGIN 
 DELETE FROM AUTHENTICATED WHERE SUID=OLD.SUID;
END;
...
FOR EACH ROW 
BEGIN 
	DELETE FROM AGENT_ACCESS WHERE AID = OLD.AID; 
END;
...
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (1, 3, 0, 1, "slider", 0, 0);   -- Anonymous / DEFAULT
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (2, 3, 0, 1, "[^/]+", 1, 1);        -- Anonymous / DEFAULT
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (3, 3, 1, 1, "location", 0, 2);    -- Authenticated / DEFAULT
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (4, 3, 0, 1, "cursor", 0, 1);   -- Anonymous / DEFAULT
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (5, 3, 0, 1, "position", 0, 4); -- Anonymous / DEFAULT
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (6, 2, 0, 3, "fan", 0, 0);         -- Anonymous / ADMIN
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (7, 2, 0, 3, "[^/]+", 1, 6);        -- Anonymous / ADMIN
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (8, 2, 1, 3, "location", 0, 7);    -- Authenticated / ADMIN
INSERT INTO OBJECT(OID, BID, SAUTH, OPID, NAME, PATTERN, PARENT) 
VALUES (9, 5, 0, 5, "billboard", 0, 0);  -- Anonymous / OWNER

-- cea user
INSERT INTO AUTHENTICATED VALUES ("73c5f1a1e7b4a75c2b5fabafca2cf51e6b0e7426",1,2);
INSERT INTO AUTHENTICATED VALUES ("73c5f1a1e7b4a75c2b5fabafca2cf51e6b0e7426",6,4);
-- fake user
INSERT INTO AUTHENTICATED VALUES ("f92fe92b61e018be14a88ab84f2859c35d832316",1,2);
INSERT INTO AUTHENTICATED VALUES ("f92fe92b61e018be14a88ab84f2859c35d832316",6,3);
-- fake2 user
INSERT INTO AUTHENTICATED VALUES ("31e63e9c4a319bf313b8a6d454798e09b3e7344a",1,2);
INSERT INTO AUTHENTICATED VALUES ("31e63e9c4a319bf313b8a6d454798e09b3e7344a",7,5);
