...
class SecuredAccessImpl implements SecuredAccess
{
	 ...
	 */
	@Override
	public String getAgentPublicKey(String bundleIdentifier) 
	...
	{
		ImmutableAccessNode root = new ImmutableAccessNode(null, "/", 
				false, null, AccessProfileOption.DEFAULT.getAccessProfile());
