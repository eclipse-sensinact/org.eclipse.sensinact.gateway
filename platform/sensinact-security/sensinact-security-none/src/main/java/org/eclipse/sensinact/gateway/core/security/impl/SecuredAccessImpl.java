...
class SecuredAccessImpl implements SecuredAccess {
    ...
    public String getAgentPublicKey(String bundleIdentifier) throws SecuredAccessException {
        return SecuredAccess.ANONYMOUS_PKEY;
    }
     ...
     */
    @Override
    public void buildAccessNodesHierarchy(String identifier, String name, MutableAccessTree<? extends MutableAccessNode> tree) throws SecuredAccessException {
        //do nothing
    }
    ...
    public void createAuthorizationService() {
        ...
        this.authorizationRegistration = this.mediator.getContext().registerService(AuthorizationService.class, authorization, null);
    }
