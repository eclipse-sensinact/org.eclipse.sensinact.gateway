...
public class MidOSGiTest implements BundleContextProvider {
    ...
    private static final Class<?>[] FRAMEWORK_FACTORY_INIT_FRAMEWORK_TYPES = new Class<?>[]{Map.class};
    ...
    public MidOSGiTest() throws MalformedURLException, IOException {
        ...
        this.createDynamicBundle(manifestFile, theDir, new File[]{new File("./target/classes"), new File("./src/main/resources")});
        this.current = Thread.currentThread().getContextClassLoader();
        this.classloader = new FilterOSGiClassLoader(current, this, new URL[]{new URL("file:target/felix/bundle/sensinact-felix-security.jar"), new URL("file:target/felix/bundle/sensinact-utils.jar"), new URL("file:target/felix/bundle/sensinact-datastore-api.jar"), new URL("file:target/felix/bundle/sensinact-core.jar"), new URL("file:target/felix/bundle/sensinact-generic.jar"), new URL("file:target/felix/bundle/http.jar"), new URL("file:target/felix/bundle/org.apache.felix.fileinstall.jar"), new URL("file:target/felix/bundle/org.osgi.compendium.jar"), new URL("file:target/felix/bundle/org.apache.felix.configadmin.jar"), new URL("file:target/felix/bundle/sensinact-northbound-access.jar"), new URL("file:target/felix/bundle/javax.servlet-api.jar"), new URL("file:target/felix/bundle/org.apache.felix.http.api.jar"), new URL("file:target/felix/bundle/org.apache.felix.http.jetty.jar"), new URL("file:target/felix/bundle/slider.jar"), new URL("file:target/felix/bundle/light.jar"), new URL("file:target/felix/load/dynamicBundle.jar")});
    }
     ...
     * @param verify whether or not to verify the JarInputStream if it is
     *               signed.
    ...
    public void createDynamicBundle(File manifestFile, File destDirectory, File... sourceDirectories) throws IOException {
        ...
        FileOutputStream fOut = new FileOutputStream(new File(destDirectory, "dynamicBundle.jar"));
        ...
        for (; index < length; index++) {
            ...
            while (enumerator.hasMoreElements()) {
                ...
                if (file.isFile()) {
                    jarOut.putNextEntry(new ZipEntry(file.getAbsolutePath().substring(sourceDirectory.getAbsolutePath().length() + 1)));
    ...
    public void init() throws Exception {
        ...
        configuration.put("org.osgi.framework.system.packages.extra", "org.eclipse.sensinact.gateway.core.security.condperm," + "com.sun.net.httpserver," + "javax.net.ssl," + "javax.xml.parsers," + "javax.imageio," + "javax.management," + "javax.naming," + "javax.sql," + "javax.swing," + "javax.swing.border," + "javax.swing.event," + "javax.management.modelmbean," + "javax.management.remote," + "javax.security.auth," + "javax.security.cert," + "org.w3c.dom," + "org.xml.sax," + "org.xml.sax.helpers," + "sun.misc," + "sun.security.action");
        ...
        configuration.put("felix.auto.start.1", "file:target/felix/bundle/org.apache.felix.configadmin.jar " + "file:target/felix/bundle/org.osgi.compendium.jar " + "file:target/felix/bundle/sensinact-felix-security.jar " + "file:target/felix/bundle/sensinact-utils.jar " + "file:target/felix/bundle/sensinact-datastore-api.jar " + "file:target/felix/bundle/org.apache.felix.fileinstall.jar ");
        configuration.put("felix.auto.start.2", "file:target/felix/bundle/sensinact-core.jar " + "file:target/felix/bundle/sensinact-generic.jar");
        configuration.put("felix.auto.start.3", "file:target/felix/bundle/javax.servlet-api.jar " + "file:target/felix/bundle/org.apache.felix.http.api.jar " + "file:target/felix/bundle/org.apache.felix.http.jetty.jar " + "file:target/felix/bundle/http.jar " + "file:target/felix/bundle/sensinact-northbound-access.jar");
        ...
        Object httpService = context.getService(context.getServiceReferences("org.apache.felix.http.api.ExtHttpService", null)[0]);
        Assert.assertTrue(httpService != null);

        Bundle bundle = context.installBundle("file:" + new File("target/felix/load/dynamicBundle.jar").getAbsolutePath());
        bundle.start();
