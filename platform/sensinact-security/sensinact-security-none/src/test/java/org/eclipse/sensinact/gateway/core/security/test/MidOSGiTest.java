...
public class MidOSGiTest implements BundleContextProvider {
	...
	public MidOSGiTest() throws MalformedURLException, IOException {
		...
		this.createDynamicBundle(manifestFile, theDir,
				new File[] { new File("./target/classes"), new File("./src/main/resources") });

		this.current = Thread.currentThread().getContextClassLoader();

		this.classloader = new FilterOSGiClassLoader(current, this,
				new URL[] { new URL("file:target/felix/bundle/sensinact-felix-security.jar"),
						...
						new URL("file:target/felix/bundle/slider.jar"), new URL("file:target/felix/bundle/light.jar"),
						new URL("file:target/felix/load/dynamicBundle.jar") });
	}

	/**
	 * Creates a new <code>JarInputStream</code> and reads the optional manifest. If
	 * a manifest is present and verify is true, also attempts to verify the
	 ...
	 */
	public void createDynamicBundle(File manifestFile, File destDirectory, File... sourceDirectories)
			throws IOException {
	...
	public void init() throws Exception {
		...
		configuration.put("org.osgi.framework.system.packages.extra",
				"org.eclipse.sensinact.gateway.core.security.condperm," + "com.sun.net.httpserver," + "javax.net.ssl,"
						+ "javax.xml.parsers," + "javax.imageio," + "javax.management," + "javax.naming," + "javax.sql,"
						+ "javax.swing," + "javax.swing.border," + "javax.swing.event," + "javax.management.modelmbean,"
						+ "javax.management.remote," + "javax.security.auth," + "javax.security.cert," + "org.w3c.dom,"
						+ "org.xml.sax," + "org.xml.sax.helpers," + "sun.misc," + "sun.security.action");
		...
		configuration.put("felix.auto.start.3", "file:target/felix/bundle/javax.servlet-api.jar "
				+ "file:target/felix/bundle/org.apache.felix.http.api.jar "
				+ "file:target/felix/bundle/org.apache.felix.http.jetty.jar " + "file:target/felix/bundle/http.jar "
				+ "file:target/felix/bundle/sensinact-northbound-access.jar");
		configuration.put("felix.auto.start.4",
				"file:target/felix/bundle/slider.jar " + "file:target/felix/bundle/light.jar ");
		...
		felix = factoryClass.getDeclaredMethod(FRAMEWORK_FACTORY_INIT_FRAMEWORK, FRAMEWORK_FACTORY_INIT_FRAMEWORK_TYPES)
		...
		autoProcessorClass.getDeclaredMethod("process", new Class<?>[] { Map.class, BundleContext.class }).invoke(null,
				new Object[] { configuration, context });
		...
		Object httpService = context
				.getService(context.getServiceReferences("org.apache.felix.http.api.ExtHttpService", null)[0]);

		Assert.assertTrue(httpService != null);

		Bundle bundle = context
				.installBundle("file:" + new File("target/felix/load/dynamicBundle.jar").getAbsolutePath());
		bundle.start();
