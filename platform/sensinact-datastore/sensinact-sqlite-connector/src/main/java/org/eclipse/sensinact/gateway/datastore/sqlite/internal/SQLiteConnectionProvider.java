...
/**
 * {@link DataStoreConnectionProvider} implementation dedicated
 * to SQLite databases connections
 */
...
{	
	...
	public SQLiteConnectionProvider(Mediator mediator,String dbName) 
			...
			UnableToFindDataStoreException
	{
		...
		{
			throw new UnableToConnectToDataStoreException(
	 ...
	 * @throws UnableToFindDataStoreException
	 */
	private void setDataStoreName(String dbName) 
			throws UnableToFindDataStoreException
	{
	 ...
	 * @inheritDoc
	 *
	 * @see DataStoreConnectionProvider#
	 * getDataStoreName()
	 */
