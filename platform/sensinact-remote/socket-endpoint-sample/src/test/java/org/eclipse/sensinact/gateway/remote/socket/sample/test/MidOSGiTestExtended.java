...
public class MidOSGiTestExtended extends MidOSGiTest {
    ...
    protected void doInit(Map configuration) {
        ...
        configuration.put("felix.auto.start.4", "file:target/felix/bundle/slider.jar " + "file:target/felix/bundle/light.jar " + "file:target/felix/bundle/dynamicBundle.jar ");
