...
/**
 * This is a simple replacement used in sensiNact to avoid any use of Unsafe.
 * It is only used on Java 17+ (which is the minimum level for sensiNact
 */
public final class SizeOf {
    ...
    /**
     * Fixed values for Unsafe constants. These may not be strictly correct but are "good enough"
     */
